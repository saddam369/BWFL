...
public class BWFL_Reciept_Details_Datatable {
	...
	private String entryNmbrOfSize_dt;
	private String gatepassNmbr_dt;

	public String getEntryNmbrOfSize_dt() {
		return entryNmbrOfSize_dt;
	}
	public void setEntryNmbrOfSize_dt(String entryNmbrOfSize_dt) {
		this.entryNmbrOfSize_dt = entryNmbrOfSize_dt;
	}
