...
public class BWFL_BrandDetailDataTable {
	...
	public ArrayList getImfl_type_list() {
		this.imfl_type_list = new BWFLBrandRegistrationImpl().liqTypeListImpl(this);
	...
	public ArrayList getLiq_cat_list() {
		this.liq_cat_list = new BWFLBrandRegistrationImpl().liqCatListImpl(this);
		return liq_cat_list;
	}
