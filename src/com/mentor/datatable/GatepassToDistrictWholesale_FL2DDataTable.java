...
public class GatepassToDistrictWholesale_FL2DDataTable {
	...
	private String finalizedFlag_show;

	public String getFinalizedFlag_show() {
		return finalizedFlag_show;
	}

	public void setFinalizedFlag_show(String finalizedFlag_show) {
		this.finalizedFlag_show = finalizedFlag_show;
	}
	
	private String shopId_dt;

	public String getShopId_dt() {
		return shopId_dt;
	}

	public void setShopId_dt(String shopId_dt) {
		this.shopId_dt = shopId_dt;
	}
