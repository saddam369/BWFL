...
public class BrandRegistrationForOtherDistilleryForCSD_BrandDetailDatatable {
	...
	public ArrayList getImfl_type_list() {
		this.imfl_type_list = new BrandRegistrationForOtherDistilleryForCSDImpl().liqTypeListImpl(this);
	...
	public ArrayList getLiq_cat_list() {
		this.liq_cat_list = new BrandRegistrationForOtherDistilleryForCSDImpl().liqCatListImpl(this);
		return liq_cat_list;
	}
