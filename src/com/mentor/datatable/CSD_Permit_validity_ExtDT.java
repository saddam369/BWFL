...
import com.mentor.impl.FL2D_Permit_validity_ExtImpl;
	...
	public class CSD_Permit_validity_ExtDT {
		...
		private String digital_sign_appId_dt;
		 ...
		 private Date digital_sign_date;
		 private String digital_sign_pdfNm_dt;
		 
		 
		
		
		public String getDigital_sign_pdfNm_dt() {
			return digital_sign_pdfNm_dt;
		}

		public void setDigital_sign_pdfNm_dt(String digital_sign_pdfNm_dt) {
			this.digital_sign_pdfNm_dt = digital_sign_pdfNm_dt;
		}

		public Date getDigital_sign_date() {
			return digital_sign_date;
		}

		public void setDigital_sign_date(Date digital_sign_date) {
			this.digital_sign_date = digital_sign_date;
		}
