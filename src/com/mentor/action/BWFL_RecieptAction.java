...
import com.mentor.impl.BWFL_RecieptImpl;
import com.mentor.utility.ResourceUtil;
import com.mentor.utility.Validate;

public class BWFL_RecieptAction {
	BWFL_RecieptImpl impl = new BWFL_RecieptImpl();
	...
	public ArrayList getBwfl_datalist() {
		...
		this.bwfl_datalist = new BWFL_RecieptImpl().getDetails_BWFL(this);
	...
	public String getHidden() {
		new BWFL_RecieptImpl().getDetails(this);		
		return hidden;
	}
	...
	public String view_details(){
		...
		this.view_formData = new BWFL_RecieptImpl().getFormDetails(this,reciptDetail);
		}catch(Exception e)
		{
			e.printStackTrace();
		}
	...
	public ArrayList getReciept_list() {
		...
		this.reciept_list = new BWFL_RecieptImpl().getRecieptsList(this);
		return reciept_list;
	}
