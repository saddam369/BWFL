...
public class Rollover_Stock_BWFL_18_19Action {


	Rollover_Stock_BWFL_18_19Impl impl =new Rollover_Stock_BWFL_18_19Impl();
	Rollover_Stock_BWFL_18_19DT prt;
	...
	public Rollover_Stock_BWFL_18_19DT getPrt() {
		return prt;
	}

	public void setPrt(Rollover_Stock_BWFL_18_19DT prt) {
		this.prt = prt;
	}
...
public void deleteRowMethod(ActionEvent e) {
	...
	Rollover_Stock_BWFL_18_19DT dt = (Rollover_Stock_BWFL_18_19DT) this.displaylist.get(uiTable.getRowIndex());
...
public int getTotalbox() {
	try {
		...
		for (int i = 0; i < this.getDisplaylist().size(); i++) {
			Rollover_Stock_BWFL_18_19DT dt = new Rollover_Stock_BWFL_18_19DT();
			dt = (Rollover_Stock_BWFL_18_19DT) this.getDisplaylist().get(i);
...
public String finalizeData()
{
	...
	try{
		...
		new Rollover_Stock_BWFL_18_19Impl().dataFinalize(this,prt);
...
private int unit_id_brand;




public int getUnit_id_brand() {
	return unit_id_brand;
}

public void setUnit_id_brand(int unit_id_brand) {
	this.unit_id_brand = unit_id_brand;
}
