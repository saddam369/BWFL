...
import com.mentor.impl.AdvanceDutyRegisterBWFL_FL2D_DEOImpl;

public class AdvanceDutyRegisterBWFL_FL2D_DEOAction {
	
	AdvanceDutyRegisterBWFL_FL2D_DEOImpl impl=new AdvanceDutyRegisterBWFL_FL2D_DEOImpl();
	...
	private ArrayList unitLsit = new ArrayList();
	...
	public ArrayList getUnitLsit() {
		return unitLsit;
	}

	public void setUnitLsit(ArrayList unitLsit) {
		this.unitLsit = unitLsit;
	}
	...
	Date date1 = new SimpleDateFormat("dd/MM/yyyy").parse(st);
			...
			if (this.fromdate.before(date1)) {
				...
				"From Date should not be less than 01 APRIL 2020","From Date should not be less than 01 APRIL 2020"));
				...
				try {
					...
					if(this.type!=null && this.todate!=null && this.unit_id!=null){
	...
	public ArrayList getTypeList() {
		this.typeList = impl.getTypeList(this);
		return typeList;
	}
	...
	public void radioListener(ValueChangeEvent e){
		...
		this.unitLsit=impl.getUniitList(this);
	}
