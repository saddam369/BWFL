...
import com.mentor.impl.BWFL_RecieptImpl_20_21;
import com.mentor.utility.Validate;

public class BWFL_RecieptAction_20_21 {
	BWFL_RecieptImpl_20_21 impl = new BWFL_RecieptImpl_20_21();
	...
	private BWFL_RecieptDatatable reciptDetail;
	public BWFL_RecieptDatatable getReciptDetail() {
		return reciptDetail;
	}
	public void setReciptDetail(BWFL_RecieptDatatable reciptDetail) {
		this.reciptDetail = reciptDetail;
	}
	public ArrayList getBwfl_datalist() {
		
		this.bwfl_datalist = new BWFL_RecieptImpl_20_21().getDetails_BWFL(this);
	...
	public String getHidden() {
		new BWFL_RecieptImpl_20_21().getDetails(this);		
		return hidden;
	}
	...
	public String view_details(){
		...
		this.view_formData = new BWFL_RecieptImpl_20_21().getFormDetails(this,reciptDetail);
		}catch(Exception e)
		{
			e.printStackTrace();
		}
	...
	public boolean isValid() {
		...
		if(valid){	       	      		 
	       			...
	       			BWFL_Reciept_Details_Datatable table=new BWFL_Reciept_Details_Datatable();	
	               	table=(BWFL_Reciept_Details_Datatable)this.view_formData.get(i);                	
	           		if(!(Validate.validateStrReq("Recievedby",this.getRecievedby())))valid=false;
	                  // else if(!(Validate.validateStrReq("recievedliquor", table.getReceived_liqour())))valid=false;
	                   //else if(!(Validate.validateOnlyInt("recievedliquor", table.getReceived_liqour())))valid=false;
	...
	public ArrayList getReciept_list() {
		...
		this.reciept_list = new BWFL_RecieptImpl_20_21().getRecieptsList(this);
		return reciept_list;
	}
