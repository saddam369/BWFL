...
import com.mentor.impl.rolloverstock_WFL_impl;



public class rolloverstock_WFL_action {
	rolloverstock_WFL_impl impl=new rolloverstock_WFL_impl ();
 ...
 if (this.getSavelog_id()==this.getLoginid()) {
	...
	public void scanAndUpload(ActionEvent e){
		UIDataTable uiTable = (UIDataTable) e.getComponent().getParent()
				.getParent();
		rolloverstock_WFL_action act= new rolloverstock_WFL_action();
		rolloverstock_WFL_dt dt=(rolloverstock_WFL_dt) this.getDisplaylist() .get(uiTable.getRowIndex());
