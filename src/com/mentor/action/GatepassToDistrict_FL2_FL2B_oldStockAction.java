...
public class GatepassToDistrict_FL2_FL2B_oldStockAction {
	...
	public double getDb_total_value() {
		...
		try {
			...
			for (int i = 0; i < this.displaylist.size(); i++) {
				GatepassToDistrict_FL2_FL2B_oldStockDT dt = (GatepassToDistrict_FL2_FL2B_oldStockDT) this.getDisplaylist().get(i);
	...
	public void calculateTotalDuty(ActionEvent ae) {
		if (isFlag()) {
			this.setSum(0);
			for (int i = 0; i < this.displaylist.size(); i++) {
				GatepassToDistrict_FL2_FL2B_oldStockDT dt = (GatepassToDistrict_FL2_FL2B_oldStockDT) this.displaylist.get(i);
	...
	public boolean isValidateInput1() {
		...
		for (int i = 0; i < this.displaylist.size(); i++) {
			GatepassToDistrict_FL2_FL2B_oldStockDT dt = (GatepassToDistrict_FL2_FL2B_oldStockDT) displaylist.get(i);
		...
		try {
			if (isValidateInput1()) {
				if (this.dt_date.after(this.validtilldt_date)) {
					FacesContext.getCurrentInstance().addMessage(null,new FacesMessage(FacesMessage.SEVERITY_ERROR,
					"Invalid Valid Till Date !!","Invalid Valid Till Date !!"));
				} else {					
	...
	public void printReport(ActionEvent e) {
		UIDataTable uiTable = (UIDataTable) e.getComponent().getParent()
				.getParent();
		GatepassToDistrict_FL2_FL2B_oldStockDT dt = (GatepassToDistrict_FL2_FL2B_oldStockDT) this.table2List
	...
	public String csvSubmit() throws IOException {
		...
		for (int ik = 0; ik < getVal.size(); ik++) {
			GatepassToDistrict_FL2_FL2B_oldStockDT dt = (GatepassToDistrict_FL2_FL2B_oldStockDT) this
					.getGetVal().get(ik);
	...
	public void deleteRowMethodPackaging(ActionEvent e) {
		...
		GatepassToDistrict_FL2_FL2B_oldStockDT dt = (GatepassToDistrict_FL2_FL2B_oldStockDT) this.displaylist.get(uiTable.getRowIndex());
