...
import com.mentor.impl.GatepassToDistrict_FL2_FL2B_Impl;
import com.mentor.utility.Validate;

public class GatepassToDistrict_FL2_FL2B_Action {

	GatepassToDistrict_FL2_FL2B_Impl impl = new GatepassToDistrict_FL2_FL2B_Impl();
	...
	public boolean isValidateInput1() {
		...
		for (int i = 0; i < this.displaylist.size(); i++) {
			GatepassToDistrict_FL2_FL2B_DT dt = (GatepassToDistrict_FL2_FL2B_DT) displaylist
					.get(i);
	   ...
	   if ((dt.getDispatchbottls()) > dt.getInt_bottle_avaliable()) {
			...
			/*sumBoxes += dt.getDispatchbox();
			  ...
			  if (dt.getDispatchbox() > dt.getBoxAvailable()) {
				FacesContext
						.getCurrentInstance()
						.addMessage(
								null,
	...
	public void saveMethod() {
		try {
			if (isValidateInput1()) {
				...
				else if(this.vch_to.equalsIgnoreCase("BRC") && impl.checklic(this).equalsIgnoreCase("F")){
						
						for(int i =0; i <this.displaylist.size();i++){
				
							 GatepassToDistrict_FL2_FL2B_DT dt = (GatepassToDistrict_FL2_FL2B_DT) this.displaylist.get(i);
...
private String pdfname_CaseCode;
	...
	public void printReport(ActionEvent e) {
		UIDataTable uiTable = (UIDataTable) e.getComponent().getParent()
				.getParent();
		GatepassToDistrict_FL2_FL2B_DT dt = (GatepassToDistrict_FL2_FL2B_DT) this.table2List
	...
	public String importExcel() {
		/*if(this.fl2LicenseType.equalsIgnoreCase("FL2")){
			new GatepassToDistrict_FL2_FL2B_Impl().saveExcelDatafl(this);
		}else{*/
		new GatepassToDistrict_FL2_FL2B_Impl().saveExcelData(this);
		//}
		this.tableFlag = true;
	...
	// data------------------
	public void delete() {
		new GatepassToDistrict_FL2_FL2B_Impl().deleteData(this);
		this.tableFlag = false;
		this.finalsubmit = false;
		this.cancelFlag = false;
		this.gatePassFlag = false;
	...
	// ==========================code for csv===================================
		...
		impl.saveCSV(this);
			...
			if(this.getFl2LicenseType().equalsIgnoreCase("CL2")){
			 ...
			 {
			 GatepassToDistrict_FL2_FL2B_DT dt=	 (GatepassToDistrict_FL2_FL2B_DT)this.getGetVal().get(ik);
