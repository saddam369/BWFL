...
import com.mentor.impl.RollOverStock_fl2d_NonRenewedBrandImpl;

public class RollOverStock_fl2d_NonRenewedBrandAction {

	
	

	RollOverStock_fl2d_NonRenewedBrandImpl impl=new RollOverStock_fl2d_NonRenewedBrandImpl();
	...
	RollOverStock_fl2d_NonRenewedBrandDT prt;
	public RollOverStock_fl2d_NonRenewedBrandDT getPrt() {
		return prt;
	}

	public void setPrt(RollOverStock_fl2d_NonRenewedBrandDT prt) {
		this.prt = prt;
	}
...
//-----------------------------Delete methods --------Created by Arvind-Verma----------------------------------------------------------		  
	...
	public String finalizeData()
	{
		...
		try{
			...
			if(!new RollOverStock_fl2d_NonRenewedBrandImpl().validatechallan(this,prt)){
				FacesContext.getCurrentInstance().addMessage(null, new FacesMessage("Challan  Not Found ! ", "Challan  Not Found!"));	
			}else
			{
			boolean flag=new RollOverStock_fl2d_NonRenewedBrandImpl().updatechallandetail(this,dt);
			if(flag)
			{
...
public void deleteRowMethodlabel(ActionEvent e) {
	UIDataTable uiTable = (UIDataTable) e.getComponent().getParent()
			.getParent();
	RollOverStock_fl2d_NonRenewedBrandDT dt = (RollOverStock_fl2d_NonRenewedBrandDT) this.getChallantable().get(uiTable.getRowIndex());
