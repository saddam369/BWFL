...
import com.mentor.impl.FL2_2B_StockImpl19_20;
import com.mentor.utility.Validate;

//new action
public class FL2_2B_StockAction19_20 {

	FL2_2B_StockImpl19_20 impl = new FL2_2B_StockImpl19_20();
...
private String vchFrom;
	...
	public void saveMethod() {
		...
		if (isValidateInput1()) {
			for (int i = 0; i < this.gatePssDisplaylist.size(); i++) {
				FL2_2B_StockDataTable19_20 dt = (FL2_2B_StockDataTable19_20) this
	...
	public boolean isValidateInput1() {
		...
		for (int i = 0; i < this.gatePssDisplaylist.size(); i++) {
			FL2_2B_StockDataTable19_20 dt = (FL2_2B_StockDataTable19_20) gatePssDisplaylist
					.get(i);
	...
	public void delete() {
		new FL2_2B_StockImpl19_20().deleteData(this);
	...
	public String importExcel() {
		...
		if (gatePassNo != null && createdDate != null && licenseing != null) {
			new FL2_2B_StockImpl19_20().saveExcelData(this);
		}
		// this.getImpdatalist();
