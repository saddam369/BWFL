...
import com.mentor.impl.ImportChallanForPermitBWFL_FL2DImpl;

public class ImportChallanForPermitBWFL_FL2DAction {
	...
	ImportChallanForPermitBWFL_FL2DImpl impl = new ImportChallanForPermitBWFL_FL2DImpl();
		...
		if (validateInput) {
			if (this.datalist.size() > 0) {
				...
				for (int i = 0; i < datalist.size(); i++) {
					...
					dt = (ImportChallanForPermitBWFL_FL2DDT) this.datalist
							.get(i);
