...
import com.mentor.impl.BWFLGatepass36_OldStock_18_19Impl;
import com.mentor.utility.Validate;

public class BWFLGatepass36_OldStock_18_19Action {

	BWFLGatepass36_OldStock_18_19Impl impl = new BWFLGatepass36_OldStock_18_19Impl();
	...
	BWFLGatepass36_OldStock_18_19DT dt1 = (BWFLGatepass36_OldStock_18_19DT) this.getDisplaylist1().get(ii);
	...
	if(dt1.isSelected())
	{
		...
		{
			BWFLGatepass36_OldStock_18_19DT dt = (BWFLGatepass36_OldStock_18_19DT) this.getDisplaylist().get(i);
		...
		for (int i = 0; i < this.displaylist.size(); i++) {
			BWFLGatepass36_OldStock_18_19DT dt = (BWFLGatepass36_OldStock_18_19DT) displaylist
					.get(i);
	...
	public void printReport(ActionEvent e) {
		...
		BWFLGatepass36_OldStock_18_19DT dt = (BWFLGatepass36_OldStock_18_19DT) this.table2List.get(uiTable.getRowIndex());
	...
	public double getDb_total_value() {
		...
		try {
			...
			for (int i = 0; i < this.displaylist.size(); i++) {
				BWFLGatepass36_OldStock_18_19DT dt = (BWFLGatepass36_OldStock_18_19DT) this
	...
	public void calculateTotalDuty(ActionEvent ae) {
		...
		if (isFlag()) {
			this.setSum(0);
			for (int i = 0; i < this.displaylist.size(); i++) {
				BWFLGatepass36_OldStock_18_19DT dt = (BWFLGatepass36_OldStock_18_19DT) this.displaylist
						.get(i);
	...
	public void scanAndUpload(ActionEvent ae) {
		UIDataTable uiTable = (UIDataTable) ae.getComponent().getParent()
				.getParent();
		BWFLGatepass36_OldStock_18_19DT dt = (BWFLGatepass36_OldStock_18_19DT) this.table2List
	...
	private BWFLGatepass36_OldStock_18_19DT edidata;

	public BWFLGatepass36_OldStock_18_19DT getEdidata() {
		return edidata;
	}

	public void setEdidata(BWFLGatepass36_OldStock_18_19DT edidata) {
...
public void calculateTotalCeshDuty(ActionEvent ae) {
	...
	if (isCeshflag()) {
		this.setCeshsum(0);
		for (int i = 0; i < this.displaylist.size(); i++) {
			BWFLGatepass36_OldStock_18_19DT dt = (BWFLGatepass36_OldStock_18_19DT) this.displaylist.get(i);
