...
//new action
public class FL2_2B_StockAction {

	FL2_2B_StockImpl impl = new FL2_2B_StockImpl();
	...
	public void saveMethod() {
		...
		if (isValidateInput1()) {
			for (int i = 0; i < this.gatePssDisplaylist.size(); i++) {
				FL2_2B_StockDataTable dt = (FL2_2B_StockDataTable) this
	...
	public boolean isValidateInput1() {
		...
		for (int i = 0; i < this.gatePssDisplaylist.size(); i++) {
			FL2_2B_StockDataTable dt = (FL2_2B_StockDataTable) gatePssDisplaylist
					.get(i);
	...
	public void delete() {
		new FL2_2B_StockImpl().deleteData(this);
	...
	public String importExcel() {
		...
		if (gatePassNo != null && createdDate != null && licenseing != null) {
			new FL2_2B_StockImpl().saveExcelData(this);
		}
		// this.getImpdatalist();
