...
public class BWFLImportAction_20_21 {
	BWFLImportImpl_20_21 impl = new BWFLImportImpl_20_21();
    ...
    private BWFLImportDataTable_20_21 datatable;
	...
	public BWFLImportDataTable_20_21 getDatatable() {
		return datatable;
	}

	public void setDatatable(BWFLImportDataTable_20_21 datatable) {
	...
	public ArrayList getLicno() {
		...
		try{
			this.licno=new BWFLImportImpl_20_21().getLicense();
		}catch(Exception e)
		{
			e.printStackTrace();
		}
	...
	public void deleteRowMethodPackaging(ActionEvent e) {
		UIDataTable uiTable = (UIDataTable) e.getComponent().getParent()
				.getParent();
		BWFLImportDataTable_20_21 dt = (BWFLImportDataTable_20_21) this.brandPackagingDataList
...
//System.out.println("distillery_id="+distillery_id);
		...
		if (validateInput) {
			if (this.brandPackagingDataList.size() > 0) {
				for (int i = 0; i < brandPackagingDataList.size(); i++) {
					...
					table = (BWFLImportDataTable_20_21) brandPackagingDataList.get(i);
	...
	BWFLImportDataTable_20_21 bopd;

	public BWFLImportDataTable_20_21 getBopd() {
		return bopd;
	}

	public void setBopd(BWFLImportDataTable_20_21 bopd) {
		this.bopd = bopd;
	}
	...
	public String finalizeData() {
		...
		try {
			new BWFLImportImpl_20_21().dataFinalize(this, bopd);
		} catch (Exception e) {
			e.printStackTrace();
		}
...
/*	public void cancelData(ActionEvent e) {
		try {
			...
			BWFLImportDataTable_20_21 dt = (BWFLImportDataTable_20_21) this.showDataTableList.get(uiTable.getRowIndex());             
	...
	public void print() {
		...
		try {
			// new BWFLImportImpl_20_21().generateReport(bopd, this);
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public void deleteData(ActionEvent e) {
		UIDataTable uiTable = (UIDataTable) e.getComponent().getParent()
				.getParent();
		BWFLImportDataTable_20_21 dt = (BWFLImportDataTable_20_21) this.displayDataList
				.get(uiTable.getRowIndex());
	...
	public void updateValidDate(ActionEvent e) {
		UIDataTable uiTable = (UIDataTable) e.getComponent().getParent()
				.getParent();
		BWFLImportDataTable_20_21 dt = (BWFLImportDataTable_20_21) this.displayDataListExt.get(uiTable.getRowIndex());
...
if(this.isData_list_reload_Flag())
{
	...
	public double getDb_totalFees() {
		...
		try {
			...
			for (int i = 0; i < this.brandPackagingDataList.size(); i++) {
				BWFLImportDataTable_20_21 dt = (BWFLImportDataTable_20_21) this.getBrandPackagingDataList().get(i);
	...
	public void calculateTotalFee(ActionEvent ae) {
		...
		this.setSum(0);
		for (int i = 0; i < this.brandPackagingDataList.size(); i++) {
			BWFLImportDataTable_20_21 dt = (BWFLImportDataTable_20_21) this.brandPackagingDataList.get(i);
...
/*	public String getUnit_name() {
	...
	public void cancelRequest() {
	 ...
	 private BWFLImportDataTable_20_21 cancelData;	
		...
		public BWFLImportDataTable_20_21 getCancelData() {
		...
		public void setCancelData(BWFLImportDataTable_20_21 cancelData) {
		...
		public String showPopUpData()
		{
			try{
				...
				int fl36_box=new BWFLImportImpl_20_21().checkFl36GatepassBwfl(datatable);
				int fl11_box=new BWFLImportImpl_20_21().checkFl11GatepassBwfl(datatable); 
		...
		public void cancelOrder()
		{
			...
			try{
				if(isPopupValidate())
					{
					new BWFLImportImpl_20_21().cancelPermit(this.cancelData, this);
						}
			}catch(Exception e)
			{
				e.printStackTrace();
	...
	String name="";
		...
		try {
			...
			if (filePath != null) {
				...
				name=new BWFLImportImpl_20_21().getUploadSequence()+".pdf";
 ...
 */
	  ...
	  * bwfl method in impl
	  */
	  private BWFLImportDataTable_20_21 BWFLImportDataTable_20_21;
	 public BWFLImportDataTable_20_21 getBWFLImportDataTable_20_21() {
		return BWFLImportDataTable_20_21;
	}

	public void setBWFLImportDataTable_20_21(BWFLImportDataTable_20_21 BWFLImportDataTable_20_21) {
		this.BWFLImportDataTable_20_21 = BWFLImportDataTable_20_21;
	}
	...
	public void rePrint()
	 {
		 ...
		 try{
			 new BWFLImportImpl_20_21().printReportBWFL(this.BWFLImportDataTable_20_21);
		 }catch(Exception e)
		 {
			 e.printStackTrace();
		 }
