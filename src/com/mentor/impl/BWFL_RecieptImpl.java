...
import com.mentor.action.BWFL_RecieptAction;
...
public class BWFL_RecieptImpl {

	public void getDetails(BWFL_RecieptAction ac){
		Connection con = null;
		PreparedStatement ps = null;
		ResultSet rs = null;
		String query = 	" SELECT * FROM bwfl.registration_of_bwfl_lic_holder_19_20 WHERE " +
	...
	public ArrayList getDetails_BWFL(BWFL_RecieptAction ac){
		...
		String selQr = 	" SELECT DISTINCT int_distillery_id ,permitno ,permitdt,gatepass_no,licence_no " +
						...
						" WHERE  int_distillery_id="+ac.getBwfl_int_id_pk()+" and dispatch_date<'2020-04-01' and  " +
	...
	public ArrayList getFormDetails(BWFL_RecieptAction ac, BWFL_RecieptDatatable dt){
		Connection con = null;
		PreparedStatement ps = null;
		ResultSet rs = null;
		ArrayList list = new ArrayList();
		...
		String selQr = 	" SELECT DISTINCT a.int_distillery_id, a.int_brand_id, a.int_pack_id, a.int_quantity,a.permitno,c.brand_name," +
						...
						" a.finalized_date, a.finalized_flag, entry_no_of_bottle_per_case as box_size" +
						//" d.box_size " +
						" FROM bwfl_license.mst_bottling_plan_19_20 a ,bwfl.registration_of_bwfl_lic_holder_19_20 b,distillery.brand_registration_19_20 c " +
						...
						" and a.gatepass_no='"+dt.getPassno()+"' order by a.cr_date ";
		try{
			con = ConnectionToDataBase.getConnection();
			ps = con.prepareStatement(selQr);
	...
	public void saveDetail(BWFL_RecieptAction ac ){
		Connection con = null;
	...
	for (int i = 0; i < ac.getView_formData().size(); i++) {
		...
		BWFL_Reciept_Details_Datatable dt = (BWFL_Reciept_Details_Datatable) ac.getView_formData().get(i);
 		...
 		String query = 	" INSERT INTO bwfl_license.mst_receipt_19_20(int_bwfl_id, int_brand_id, int_pack_id, " +
  ...
  String query5 = " SELECT * FROM bwfl_license.receipt_stock_19_20 where int_brand_id="+dt.getInt_brand_id()+" " +
   ...
   String query3 = " INSERT INTO bwfl_license.receipt_stock_19_20(int_bwfl_id, int_dispatched_botls, " +
				" int_dispatched_cases, int_stock_botls,   vch_lic_no, vch_lic_type, " +
				" int_brand_id, int_pckg_id,permit) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ? )";

		
   String queryy = " UPDATE bwfl_license.receipt_stock_19_20 SET int_stock_botls=int_stock_botls+?   " +
   ...
   String updtQr = " UPDATE bwfl_license.mst_bottling_plan_19_20 " +
		...
		//System.out.println("updtQr------------"+updtQr);
			...
			ps.setInt(17, this.mst_receipt_19_20()+i);
			ps.setInt(18,0);
	...
	public int mst_receipt_19_20(){
		Connection con = null;
		PreparedStatement ps = null;
		ResultSet rs = null;
		String query = "Select max(seq) as id from bwfl_license.mst_receipt_19_20";
		int id=0;
		try{
			con = ConnectionToDataBase.getConnection();
			ps = con.prepareStatement(query);
	...
	public int receipt_stock_19_20(){
		Connection con = null;
		PreparedStatement ps = null;
		ResultSet rs = null;
		String query = "Select max(int_id_pk) as id from bwfl_license.receipt_stock_19_20";
		int id=0;
		try{
			con = ConnectionToDataBase.getConnection();
			ps = con.prepareStatement(query);
	...
	public ArrayList getRecieptsList(BWFL_RecieptAction ac){
		ArrayList list = new ArrayList();
		Connection con = null;
		PreparedStatement ps = null;
		ResultSet rs = null;
		...
		/*String query = 		" SELECT a.int_bwfl_id, int_brand_id, a.int_pack_id,b.brand_name, a.int_quantity, a.permitno,a.int_planned_bottles,a.gatepass, " +
							...
							" FROM bwfl_license.mst_receipt_19_20 a ,distillery.brand_registration_19_20 b, bwfl_license.mst_bottling_plan_19_20 aa" +
							" where " +
   ...
   String query="select a.gatepass_no as gatepass,a.licence_no,a.permitno,a.int_brand_id,a.int_pack_id,a.int_planned_bottles," +
				"b.received_by,b.receiving_date,b.int_recieved_bottles,(select brand_name from distillery.brand_registration_19_20 c where c.brand_id=a.int_brand_id) as brand_name" +
				",(select package_name from distillery.packaging_details_19_20 ac where ac.package_id=a.int_pack_id) from " +
				"bwfl_license.mst_receipt_19_20 b,bwfl_license.mst_bottling_plan_19_20 a where int_distillery_id=int_bwfl_id and" +
