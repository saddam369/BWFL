...
public class BWFLImportImpl {
	public int getId(BWFLImportAction action) {
		int id = 0;
		Connection con = null;
	...
	public String getIddeo(BWFLImportAction action) {
		int id = 0;
		Connection con = null;
		Connection con2 = null;
		PreparedStatement ps = null, ps1 = null;
	...
	public int getIdMapped(BWFLImportAction action) {
		int id = 0;
		Connection con = null;
		Connection con2 = null;
		PreparedStatement ps = null, ps1 = null;
	...
	public String getLicenseNo(BWFLImportAction action, String id) {
	...
	public ArrayList getBrandName() {
		...
		BWFLImportAction bof = (BWFLImportAction) facesContext.getApplication()
				.createValueBinding("#{bWFLImportAction}").getValue(facesContext);
	...
	public String getqty(String brand_Id, String packging_Id, BWFLImportDataTable dt) {
		String qty = "";
		Connection con = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		try {
			...
			String queryList =
					...
					" SELECT a.brand_id, a.brand_name ,b.quantity, b.package_name ,b.package_id ,b.mrp "
							...
							+ "	distillery.packaging_details_20_21 b " + "	where a.brand_id=b.brand_id_fk  " +
							// " and a.distillery_id=? "+
							"	and brand_id =?  and b.package_id=?";
	...
	public void save(BWFLImportAction action) {
		...
		try {
			 ...
			 * 
			 * BWFLImportDataTable table = (BWFLImportDataTable)
			...
			if (action.getBrandPackagingDataList().size() > 0) {
				...
				for (int i = 0; i < action.getBrandPackagingDataList().size(); i++) {
					...
					BWFLImportDataTable table = (BWFLImportDataTable) action.getBrandPackagingDataList().get(i);
	...
	public void update(BWFLImportAction action) {
		...
		try {
			...
			if (saveStatus > 0) {
				saveStatus = 0;
				String sql = "update distillery.duty_register_20_21 set int_quantity='" + totalBottles + "',int_value='"
	...
	/*
	 * public void save1(BWFLImportAction action) { Connection conn = null;
	 ...
	 * 
	 * BWFLImportDataTable table = (BWFLImportDataTable) action
	...
	public ArrayList getAddRowData(BWFLImportAction ac, String lic_typ) {
	...
	public ArrayList getData(BWFLImportAction ac) {
		ArrayList list = new ArrayList();
		Connection con = null;
		PreparedStatement ps = null;
		ResultSet rs = null;
		 ...
		 * sql =
		 * 
		 * " SELECT COALESCE(a.cancel_req_dt_time,'0')cancel_req_dt_time,a.cr_date,a.caseseq,a.seqfrom,c.export_box_size,c.quantity,c.code_generate_through,coalesce(b.tracking_flg,'N') as tracking_flg,a.group_id,"
		 ...
		 * +
		 * "	FROM bwfl_license.mst_bottling_plan_20_21 a ,distillery.brand_registration_20_21 b, distillery.packaging_details_20_21"
		 * +
		 * " c ,distillery.imfl_type d where a.int_brand_id=b.brand_id  and  b.brand_id=c.brand_id_fk and"
		 * +
		 * " a.int_pack_id=c.package_id and  a.int_liquor_type=d.id and b.int_bwfl_id =(select unit_id from   bwfl.registration_of_bwfl_lic_holder_20_21 where int_id=?) AND"
		 * + " a.maped_unmaped_type='M' and  a.int_distillery_id='"
		 * +licno+"' ORDER BY a.plan_dt DESC ,seq  ";
		 */
	...
	public boolean ckeck(BWFLImportAction ac) {
	...
	public String getBrandPackagingGtinNo(BWFLImportAction action, BWFLImportDataTable dt) {
		...
		String sql = "select b.code_generate_through from distillery.brand_registration_20_21 a, distillery.packaging_details_20_21 b "
				...
				+
				// @rvind //" =?";
				// " in (select int_app_id_f from public.other_unit_registration where
				// unit_id=?) ";
		 ...
		 */
		// System.out.println("get etin="+sql);
		try {
			con = ConnectionToDataBase.getConnection();
	...
	public int getBrandPackagingNoOfBottle(BWFLImportAction action, BWFLImportDataTable dt) {
	...
	/*
	 * public boolean write(BWFLImportDataTable dt, BWFLImportAction action,
	 * Connection conn) {
	 * 
	 ...
	 * 
	 * PreparedStatement pstmt = null; ResultSet rs = null; long start = 0; long end
	 * = 0; boolean flag = false; long k = 0; String noOfUnit = ""; String date =
	 * null;
	 * 
	 * try {
	 * 
	 ...
	 * dt.getShowDataTable_LicenceType()); pstmt.setString(5, dt.getGtinno()); rs =
	 * pstmt.executeQuery(); //System.out.println("excecute query cl");
	 * 
	 ...
	 * 
	 * // Sheet sheet = workbook.createSheet(); worksheet.protectSheet("agristat");
	 * worksheet.setColumnWidth(0, 3000); worksheet.setColumnWidth(1, 8000);
	 * worksheet.setColumnWidth(2, 8000); worksheet.setColumnWidth(3, 8000);
	 ...
	 * rowhead0.createCell((int) 0); XSSFCell cellhead0 = rowhead0.createCell((int)
	 * 0); cellhead0.setCellValue("Barcode Report");
	 * 
	 * rowhead0.setHeight((short) 700); cellhead0.setCellStyle(unlockedCellStyle);
	 * XSSFCellStyle cellStyl = workbook.createCellStyle(); // HSSFCellStyle
	 ...
	 * 
	 * // ---------------------------- XSSFRow rowhead = worksheet.createRow((int)
	 * 1);
	 * 
	 ...
	 * cellhead3.setCellValue("FinalizeDate"); cellhead3.setCellStyle(cellStyle);
	 * 
	 ...
	 * cellhead5.setCellValue("BottleBarcode"); cellhead5.setCellStyle(cellStyle);
	 * 
	 ...
	 * cellhead7.setCellValue("Sub-Category"); cellhead7.setCellStyle(cellStyle);
	 * 
	 * 
	 * HSSFCell cellhead8 = rowhead.createCell((int) 7);
	 * cellhead8.setCellValue("Property No."); cellhead8.setCellStyle(cellStyle);
	 * 
	 ...
	 * cellD1.setCellValue("01" + rs.getString("gtin_no") + "13" + date + "37" +
	...
	/*
	 * public void dataFinalize(BWFLImportAction action, BWFLImportDataTable dt) {
	...
	public String getMinMaxSerialNo(BWFLImportDataTable dt, BWFLImportAction action) {
		Connection conn = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
	...
	public String getMinMaxSerialNoForExcel(BWFLImportDataTable dt, BWFLImportAction action, Connection conn) {
	...
	/*
	 * public boolean checkData(BWFLImportAction action) { boolean flag = false;
	 ...
	 * action.getBrandPackagingDataList().size(); i++) { BWFLImportDataTable table =
	 * (BWFLImportDataTable) action .getBrandPackagingDataList().get(i); //
	 * pstmt.setInt(1,getMaxChallanIdDetail()+1); pstmt.setInt(1,
	 * action.getDistillery_id()); pstmt.setInt(2, Integer.parseInt(table
	 * .getBrandPackagingData_Brand())); pstmt.setInt(3, Integer.parseInt(table
	...
	public boolean write(BWFLImportDataTable dt, BWFLImportAction action, Connection conn, int groupId) {
	...
	public ArrayList getDisplayList(BWFLImportAction act) {
	...
	public ArrayList getNewData(BWFLImportAction ac) {
		ArrayList list = new ArrayList();
		Connection con = null;
		PreparedStatement ps = null;
		ResultSet rs = null;
	...
	public ArrayList getUnit_For_Update(String id, String licenseNoNew, BWFLImportAction ac) {
		ArrayList list = new ArrayList();
		Connection con = null;
		PreparedStatement ps = null;
		ResultSet rs = null;
	...
	public boolean checkpermit(String permitno_entered, BWFLImportAction action) {
		boolean flag = false;
		Connection con = null;
		PreparedStatement ps = null;
		ResultSet rs = null;
	...
	public int delete(BWFLImportAction action) {
		...
		String query = "";
		String sql = "";
		// sql="delete from distillery.duty_register_20_21 where
		// int_id='"+action.getDutyRegisterId()+"'";
		sql = " INSERT INTO distillery.duty_register_20_21( "
				+ " int_id, int_distillery_id, date_crr_date, vch_duty_type, int_quantity, int_value, vch_description,permitno_bwfl)  "
				+ " select (select max(int_id)+1 from distillery.duty_register_20_21), int_distillery_id, date_crr_date, vch_duty_type, -int_quantity, -int_value,'Cancellation For '||vch_description,permitno_bwfl "
				+ " from distillery.duty_register_20_21  where int_id='" + action.getDutyRegisterId() + "' ";
	...
	public ArrayList getDisplayListExt(BWFLImportAction act) {
		...
		System.out.println("=getDisplayListExt====="+selQr);
	...
	public void updateValidTillExt(BWFLImportAction action, Date date) {
		...
		String bwfl_permit = "update bwfl_license.import_permit_20_21 set valid_upto=? where permit_nmbr=?";
           ...
           // System.out.println("========"+query);
			...
			if (action.getOld_valid_date().before(date)) {
				...
				saveStatus = pstmt.executeUpdate();
				//System.out.println("==11==="+saveStatus);
				if(saveStatus>0)
				{
					//System.out.println("==22==="+saveStatus);
					saveStatus=0;	
					//String bwfl_permit = "update bwfl_license.import_permit set valid_upto='"+Utility.convertUtilDateToSQLDate(date)+"' where permit_nmbr='"+action.getPermitNoNew()+"'";
					
					//System.out.println("==update==="+bwfl_permit);
				...
				if (saveStatus > 0) {
					//System.out.println("==33==="+saveStatus);
					FacesContext.getCurrentInstance().addMessage(null,
							new FacesMessage("Updated Sucessfully", "Updated Sucessfully"));
					action.reset();
				} else {
	...
	public double getPermitFee(String brand_Id, String packging_Id) {
		...
		try {
			...
			String queryList = " SELECT a.brand_id, a.brand_name, a.vch_license_type, b.package_name, b.package_id, b.permit "
					+ " FROM distillery.brand_registration_20_21 a , distillery.packaging_details_20_21 b  "
					+ " WHERE a.brand_id=b.brand_id_fk  " + " AND a.brand_id =?  AND b.package_id=? ";
	...
	public void getLicNoUnitId(BWFLImportAction action, String id) {
		Connection con = null;
		PreparedStatement ps = null;
		ResultSet rs = null;
		/*
	...
	public int getDutyRegisterId(String DutyRegisterId) {
		...
		String SQl = "select int_id from distillery.duty_register_20_21 where permitno_bwfl='" + DutyRegisterId + "'";
	...
	public void dataCancel(BWFLImportAction action) {
		Connection conn1 = null;
		PreparedStatement pstmt1 = null;
		int status = 0;
	...
	public void cancelPermit(BWFLImportDataTable dt, BWFLImportAction action) {
		Connection conn1 = null;
		Connection conn = null;
		PreparedStatement pstmt1 = null;
		PreparedStatement pstmt = null;
	...
	public int checkFl11GatepassBwfl(BWFLImportDataTable dt) {
		Connection conn = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		int i = 0;
	...
	public int checkFl36GatepassBwfl(BWFLImportDataTable dt) {
		Connection conn = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		int i = 0;
	...
	public double getBondPermitFee() {
		FacesContext facesContext = FacesContext.getCurrentInstance();
		BWFLImportAction ac = (BWFLImportAction) facesContext.getApplication().createValueBinding("#{bWFLImportAction}")
	...
	public boolean printReportBWFL(BWFLImportDataTable dt) {
	...
	public void getDataForDigitalSign(BWFLImportDataTable dt) {
		Connection conn = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
