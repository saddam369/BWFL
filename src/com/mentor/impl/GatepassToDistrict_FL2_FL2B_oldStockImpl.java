...
import com.mentor.datatable.GatepassToDistrict_FL2_FL2B_oldStockDT;
import com.mentor.resource.ConnectionToDataBase;
import com.mentor.utility.Constants;
import com.mentor.utility.ResourceUtil;
import com.mentor.utility.Utility;

public class GatepassToDistrict_FL2_FL2B_oldStockImpl {

	// =====================get fl2_fl2b
	// details=================================

	public String getDetails(GatepassToDistrict_FL2_FL2B_oldStockAction act) {
	...
	public ArrayList getbrcLicenseNo(
			GatepassToDistrict_FL2_FL2B_oldStockAction act) {
	...
	public ArrayList getlicenseNmbr(
			GatepassToDistrict_FL2_FL2B_oldStockAction act) {
	...
	public ArrayList getDistrictList(
		...
		try {
			...
			String query = " SELECT distinct coalesce(a.districtid,0) as districtid , a.description FROM public.district a ,licence.fl2_2b_2d_19_20 b"
	...
	public String getlicenseeDetail(
			GatepassToDistrict_FL2_FL2B_oldStockAction act, String val) {
	...
	public ArrayList displaylistImpl(GatepassToDistrict_FL2_FL2B_oldStockAction act) {
		...
		try {
				...
				selQr = " SELECT c.brand_id, c.pckg_id, c.id, c.type, c.size as box_size, c.exist_seq as seq,              "+
						" (c.recv_total_bottels-COALESCE(c.dispatchbotl,0)) as avlbottle,                                 "+
						" CASE WHEN c.brand_id !=0 THEN                                                                   "+
						" (SELECT b.brand_name FROM distillery.brand_registration_19_20 b WHERE b.brand_id=c.brand_id)    "+
						" else d.other_brand_name end as brand_name,                                                      "+ 
						" CASE WHEN c.pckg_id !=0 THEN                                                                    "+
						" (SELECT a.package_name FROM distillery.packaging_details_19_20 a WHERE a.package_id=c.pckg_id)  "+
						" else d.other_package_name end as package_name                                                   "+
						" FROM fl2d.fl2_2b_oldstock_18_19 c, bwfl_license.bwfl_fl2_fl2b_old_stock_18_19 d         "+                                               
						" WHERE c.exist_seq=d.seq                                                                         "+
						" AND c.recv_total_bottels-COALESCE(c.dispatchbotl,0)>0 AND c.id='"+act.getFl2_fl2bId()+"'        "+                                                                     
						" order by brand_name  ";
			...
			rs = ps.executeQuery();
			while (rs.next()) {
				GatepassToDistrict_FL2_FL2B_oldStockDT dt = new GatepassToDistrict_FL2_FL2B_oldStockDT();
	...
	public String saveMethodImpl(GatepassToDistrict_FL2_FL2B_oldStockAction act) {
		...
		try {
			...
			String insQr = 	" INSERT INTO fl2d.gatepass_to_districtwholesale_fl2_fl2b_oldstock_18_19( " +
							...
							" seq, vch_from, shop_nm, shop_id, total_duty, total_adduty) " +
							" VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) ";
			...
			ps.setDouble(20, act.getDb_total_value());
			ps.setDouble(21, act.getDb_total_add_value());
			...
			if (tok1 > 0) {
				...
				for (int i = 0; i < act.getDisplaylist().size(); i++) {
					...
					GatepassToDistrict_FL2_FL2B_oldStockDT dt = (GatepassToDistrict_FL2_FL2B_oldStockDT) act.getDisplaylist().get(i);
	...
	public String saveMethodImpl_old(GatepassToDistrict_FL2_FL2B_oldStockAction act) {
	...
	public ArrayList getTable2List1(GatepassToDistrict_FL2_FL2B_oldStockAction act, Date ev) {
		ArrayList list = null;
		Connection con = null;
		PreparedStatement ps = null;
		ResultSet rs = null;
	...
	public ArrayList getTable2List(GatepassToDistrict_FL2_FL2B_oldStockAction act) {
		ArrayList list = null;
		Connection con = null;
		PreparedStatement ps = null;
		ResultSet rs = null;

		String selqr = 	" SELECT int_fl2_fl2b_id, vch_gatepass_no, dt_date, vch_to, vch_to_lic_no, curr_date, seq, vch_from " +
						" FROM fl2d.gatepass_to_districtwholesale_fl2_fl2b_oldstock_18_19  " +
						" WHERE int_fl2_fl2b_id='"+ act.getFl2_fl2bId()+ "'  order by  seq desc";
	...
	public String getEmailDetails(GatepassToDistrict_FL2_FL2B_oldStockAction act) {
	...
	// ----------------------------------excel
	// data------------------------------------------------------
	public void saveExcelData(GatepassToDistrict_FL2_FL2B_oldStockAction action) {
		String gatepass = "";
	...
	public void saveExcelDatafl(
			GatepassToDistrict_FL2_FL2B_oldStockAction action) {
		String gatepass = "";
		int status = 0, flag = 1, excelcase = 0;
		int k[] = null;
		Connection conn = null;
	...
	public void deleteData(GatepassToDistrict_FL2_FL2B_oldStockAction action) {
		Connection con = null;
		PreparedStatement stmt = null;
	...
	public int recieveCases(GatepassToDistrict_FL2_FL2B_oldStockAction act) {
		int id = 0;
		Connection con = null;
		PreparedStatement pstmt = null, ps2 = null;
		ResultSet rs = null, rs2 = null;
	...
	public int excelCases(GatepassToDistrict_FL2_FL2B_oldStockAction act) {
		int id = 0;
		Connection con = null;
		PreparedStatement pstmt = null, ps2 = null;
		ResultSet rs = null, rs2 = null;
	...
	// ----------------------------update
	public boolean updateFL3(GatepassToDistrict_FL2_FL2B_oldStockAction act) {
		int save = 0;
		boolean val = false;
		PreparedStatement ps = null;
		Connection con = null;
	 ...
	 * 
	 * GatepassToDistrict_FL2_FL2B_oldStockDT dt =
	 * (GatepassToDistrict_FL2_FL2B_oldStockDT) act.getGetVal().get(i);
	 * 
	 ...
	 * i++) { GatepassToDistrict_FL2_FL2B_oldStockDT dt =
	 * (GatepassToDistrict_FL2_FL2B_oldStockDT) act .getGetVal().get(i);
	 * 
	...
	public void saveCSV(GatepassToDistrict_FL2_FL2B_oldStockAction action)
			throws IOException {
		Connection con = null;
		PreparedStatement stmt = null;
		action.getVal.clear();
					...
					if (sd != null) {
						...
						} else// line number >1
						{
							if (gatepass.trim().equalsIgnoreCase(
								 ...
								 * stmt.addBatch();
								 * GatepassToDistrict_FL2_FL2B_oldStockDT dt =
								 * new GatepassToDistrict_FL2_FL2B_oldStockDT();
	...
	public void saveCSVfl(GatepassToDistrict_FL2_FL2B_oldStockAction action)
			throws IOException {
		Connection con = null;
		PreparedStatement stmt = null;
	...
	public int getDetail(GatepassToDistrict_FL2_FL2B_oldStockAction act,
			String gatepass) {
	...
	public boolean printReport(GatepassToDistrict_FL2_FL2B_oldStockAction act,
			GatepassToDistrict_FL2_FL2B_oldStockDT dt) {
	...
	public void getShopDetails(GatepassToDistrict_FL2_FL2B_oldStockAction ac) {
		...
		try {
			...
			if (ac.vch_from.equalsIgnoreCase("CL2")) {
				...
				sql = " SELECT district_id , vch_name_of_shop, "
						...
						+ ac.getShopno().trim() + "' and district_id='"
						+ ac.getDistrictLic() + "' "
						+ " and  vch_shop_type in ('Model Shop','Beer')   ";
			}

			int i = 0;
			//System.out.println("faizal---" + sql);
			...
			if (i == 0) {
				FacesContext.getCurrentInstance().addMessage(
						null,
						new FacesMessage("No record found on this Shop Id",
	...
	public String checklic(GatepassToDistrict_FL2_FL2B_oldStockAction ac) {
		Connection con = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		String f = "";
	...
	public ArrayList getBrandName(){
		...
		GatepassToDistrict_FL2_FL2B_oldStockAction bof= (GatepassToDistrict_FL2_FL2B_oldStockAction)facesContext.getApplication().createValueBinding("#{gatepassToDistrict_FL2_FL2B_oldStockAction}").getValue(facesContext);
		...
		try
		{
			...
			if(licType.equalsIgnoreCase("FL2")){
				...
				sql= 	" SELECT brand_id, brand_name FROM distillery.brand_registration_19_20 " +
				 		" WHERE license_category in ('IMPORTED WINE','IMPORTED FL','WINE','IMFL','LAB','FL')  "+  
		                " ORDER BY brand_name   ";
				...
				sql= 	" SELECT brand_id, brand_name FROM distillery.brand_registration_19_20 " +
				 		" WHERE license_category in ('BEER','LAB', 'IMPORTED BEER')  "+  
		                " ORDER BY brand_name   ";
			}
