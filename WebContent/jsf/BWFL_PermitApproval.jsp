	...
	border: 1px solid #669999;
		...
		<h:form>
			<div class="container">
									...
									<TBODY>
										...
										<tr>
											<TD align="center" colspan="2"><h2>
													<h:outputText value="Pending Permit From Bonds"
														style="COLOR: #0000a0; FONT-WEIGHT: bold; FONT-SIZE: 35px;font-family:Comic Sans MS;">
													</h:outputText>
													<h:inputHidden value="#{pendingPermitAction.hidden}" />
												</h2></TD>
										</tr>
				...
				<h:panelGroup
					rendered="#{pendingPermitAction.hideDataTable and !pendingPermitAction.showMainPanel_flg}">
					<div class="row" align="center" style="BACKGROUND-COLOR: #dee0e2;">
						<div class="col-md-12" align="center">
							<h:selectOneRadio style="width:25%"
								value="#{pendingPermitAction.radioType}"
								valueChangeListener="#{pendingPermitAction.radioListener}"
					...
					<div class="row" align="center">
						<div class="col-md-12">
							<rich:dataTable id="table22" rows="10" width="100%"
								value="#{pendingPermitAction.displayRegUsers}" var="list"
...
<rich:column>
								...
								<rich:column>
									...
									<center>
										<h:commandButton value="View Details"
											actionListener="#{pendingPermitAction.viewDetails}"
											styleClass="btn btn-sm btn-primary">
										</h:commandButton>
									</center>
								</rich:column>

								<rich:column rendered="#{pendingPermitAction.radioType eq 'A'}">
									<f:facet name="header">
									...
									<center>
										<h:commandButton value="Generate"
											...
											actionListener="#{pendingPermitAction.printReport}"
								...
								<rich:column rendered="#{pendingPermitAction.radioType eq 'A'}">
									...
									<center>
										...
										<h:outputLink styleClass="outputLinkEx"
											...
											value="/doc/ExciseUp/Bond/BWFLpermit_20_21//#{list.permitNmbr_dt}_esign.pdf"
											target="_blank">
										...
										<h:outputLink styleClass="outputLinkEx"
											...
											value="/doc/ExciseUp/Bond/FL2Dpermit_20_21//#{list.permitNmbr_dt}_esign.pdf"
											target="_blank">
				...
				<div class="container-fuild">
					<h:panelGroup rendered="#{pendingPermitAction.viewPanelFlg}">
						<div class="row" align="center" style="background-color: #e6ffff">
							<div class="col-md-12">
								<h:outputText
									value="For Application ID:#{pendingPermitAction.appId}"
								...
								<table align="center" width="100%;">
									...
									<tr>
										...
										<td style="width: 200px; padding: 8px 16px;"><h:inputText
												...
												value="#{pendingPermitAction.licenseNmbr}">
											</h:inputText></td>
										<td
										...
										<td style="width: 200px; padding: 8px 16px;"><h:selectOneRadio
												...
												value="#{pendingPermitAction.byRoad_byRoute}">
										...
										<td style="width: 200px; padding: 8px 16px;"><h:inputTextarea
												...
												value="#{pendingPermitAction.routeDetail}">
											</h:inputTextarea></td>
									...
									<tr>
										...
										<td style="width: 100px; padding: 8px 16px;"><h:outputText
												...
												rendered="#{!pendingPermitAction.fl2dDutyFlg}" /></td>
										<td style="width: 200px; padding: 8px 16px;"><h:inputTextarea
												styleClass="textarea1" disabled="true"
												value="#{pendingPermitAction.parentUnitNm}"
												rendered="#{!pendingPermitAction.fl2dDutyFlg}">
											</h:inputTextarea></td>
										...
										<td style="width: 200px; padding: 8px 16px;"><h:inputTextarea
												styleClass="textarea1" disabled="true"
												value="#{pendingPermitAction.parentUnitAdrs}"
												rendered="#{!pendingPermitAction.fl2dDutyFlg}">
										...
										<td style="width: 200px; padding: 8px 16px;"><h:inputText
												disabled="true" styleClass="inputtext"
												value="#{pendingPermitAction.parentUnitState}"
												rendered="#{!pendingPermitAction.fl2dDutyFlg}"></h:inputText></td>
									...
									<tr>
										...
										<td colspan="2" style="padding: 8px 16px;"><h:inputTextarea
												styleClass="textarea1" disabled="true"
												value="#{pendingPermitAction.consignorNmAdrs}"
												rendered="#{pendingPermitAction.fl2dDutyFlg}" /></td>
									...
									<tr>
										...
										<td style="width: 200px; padding: 8px 16px;"><h:selectOneRadio
												style="width:80%" disabled="true"
												rendered="#{!pendingPermitAction.fl2dDutyFlg}"
												value="#{pendingPermitAction.mapped_unmapped}">
									...
									<div class="row" align="center">
										<div class="col-md-12">
											<rich:dataTable id="table2p" width="100%"
												value="#{pendingPermitAction.displayBrandDetails}"
												...
												<rich:column rendered="#{!pendingPermitAction.fl2dDutyFlg}">
													<f:facet name="header">
													...
													<f:facet name="footer">
														<h:outputText id="totalduty"
															value="#{pendingPermitAction.totalDuty}"
															styleClass="generalHeaderOutputTable">
															<f:convertNumber maxFractionDigits="2"
																pattern="#############0.00" />
														</h:outputText>
												...
												<rich:column>
													...
													<f:facet name="footer">
														<h:outputText id="totalfees"
															value="#{pendingPermitAction.totalImportFee}"
															styleClass="generalHeaderOutputTable">
															<f:convertNumber maxFractionDigits="2"
																pattern="#############0.00" />
														</h:outputText>
												...
												<rich:column>
													...
													<f:facet name="footer">
														<h:outputText id="totscanfees"
															value="#{pendingPermitAction.total_scanning_fee}"
															styleClass="generalHeaderOutputTable">
															<f:convertNumber maxFractionDigits="2"
																pattern="#############0.00" />
														</h:outputText>
												...
												<rich:column>
													...
													<f:facet name="footer">
														<h:outputText id="totspclfees"
															value="#{pendingPermitAction.totalSpecialFee}"
															styleClass="generalHeaderOutputTable">
															<f:convertNumber maxFractionDigits="2"
																pattern="#############0.00" />
														</h:outputText>
				...
				<h:panelGroup
					rendered="#{pendingPermitAction.radioType ne 'R' and
					pendingPermitAction.flag_challan eq 'T' 
					 and pendingPermitAction.viewPanelFlg}">
						...
						<div class="row" align="center">
							<div class="col-md-12">
								<rich:dataTable id="table3" width="100%"
									value="#{pendingPermitAction.displayChalanDetails}" var="list"
									headerClass="TableHead" footerClass="TableHead"
									styleClass="DataTable" rowClasses="TableRow1,TableRow2">
				...
				<h:panelGroup rendered="#{pendingPermitAction.radioType ne 'R'
                     and pendingPermitAction.viewPanelFlg and pendingPermitAction.flag_import eq 'T'}">
           
                   <div class="row">
							<div class="col-md-6" align="left" style="margin-bottom: 5px;">
										<b style="COLOR: #000080;">Total Advance Import Fee  :: </b>
										${pendingPermitAction.total_advance_importFee }
							</div>

									
									<div class="col-md-6" align="left" style="margin-bottom: 5px;">
										<b style="COLOR: #000080;">Total Advance Special Fee ::</b>
							${pendingPermitAction.total_advance_specialFee}
									</div>
									<div class="col-md-6" align="left" style="margin-bottom: 5px;">
										 <h:outputLink styleClass="outputLinkEx"
											 
											value="https://www.upexciseonline.in/auth/portal/BWFL/Duty+register+all"
											target="_blank">
											<h:outputText styleClass="outputText" id="text223"
					...
					<div class="row" align="center" style="BACKGROUND-COLOR: #c5cfe5;">
						...
						<div class="col-md-12">
							<div class="col-md-3" align="right">
								<b><h:outputText
										rendered="#{pendingPermitAction.radioType ne 'N'}"
										value="Excise-DEO #{pendingPermitAction.districtName} Remark:" /></b>
							</div>
							<div class="col-md-5" align="left">
								<h:inputTextarea value="#{pendingPermitAction.deoRemrks}"
							...
							<div class="col-md-2" align="right">
								<b><h:outputText value="Valid Upto::"
										rendered="#{pendingPermitAction.radioType ne 'N'}" /></b>

							</div>
							<div class="col-md-2" align="left">
								<h:inputText styleClass="form-control" readonly="true"
									rendered="#{pendingPermitAction.radioType ne 'N'}"
									value="#{pendingPermitAction.validUptoDt}">
								</h:inputText>
						...
						<div class="col-md-12">
							<div class="col-md-3" align="right">
								<b><h:outputText
										rendered="#{pendingPermitAction.radioType ne 'R'}"
										value="* Remarks::" /></b>
							...
							<div class="col-md-5" align="left">
								<h:inputText style="width: 100%; height : 70px;"
									styleClass="form-control"
									rendered="#{pendingPermitAction.radioType ne 'R'}"
									value="#{pendingPermitAction.fillRemrks}">
								</h:inputText>
							</div>
							<div class="col-md-2" align="right">
								<b><h:outputText
										rendered="#{pendingPermitAction.radioType eq 'N'}"
										value="* Valid Upto::" /></b>
							...
							<div class="col-md-2" align="left">
								<rich:calendar
									rendered="#{pendingPermitAction.radioType eq 'N'}"
									value="#{pendingPermitAction.fillValidDt}">
								</rich:calendar>
						...
						<div class="col-md-12">
							...
							<div class="col-md-7" align="left">
								<h:selectBooleanCheckbox
									rendered="#{pendingPermitAction.radioType eq 'N'}"
									value="#{pendingPermitAction.checkBox}" id="chkRememberMe" />
...
<a4j:outputPanel rendered="#{pendingPermitAction.control_id ne 'NA'}">
<div class="row" align="center">
						...
						<div class="col-md-2">
						<h:selectOneMenu value="#{pendingPermitAction.objectionRejectionCode}" styleClass="form-control">
						<f:selectItems value="#{pendingPermitAction.rejectionList}"/>
						</h:selectOneMenu>
						</div>
						<div class="col-md-4"></div>
						</div>
					...
					<div class="row" align="center">
						...
						<h:commandButton value="Close" styleClass="btn btn-default btn-sm"
							action="#{pendingPermitAction.closeApplication}" />
			...
			<h:panelGroup rendered="#{pendingPermitAction.showMainPanel_flg}">
				<div style="margin: 10px;">
						...
						<div class="col-md-6" align="center">
							<div
								...
								<h2 style="COLOR: #000080;">Application Approved
									...
									#{pendingPermitAction.popupPermitNmbr}</h2>
							</div>
						</div>
						<div class="col-md-3"></div>
					...
					<div class="row" align="center" style="margin-top: 15px;">
						<h:commandButton value="Close" class="btn btn-info"
							action="#{pendingPermitAction.closePopup}"></h:commandButton>
					</div>
				</div>
			</h:panelGroup>
