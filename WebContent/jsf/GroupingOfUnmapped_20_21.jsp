					...
					<TABLE width="100%" align="center">
									...
									<TBODY>
										<TR align="center">
											...
											<TD align="center" width="100%" class="pghead"><h:inputHidden
													value="#{groupingOfUnmappedAction_20_21.hidden}"></h:inputHidden>
												<h2>
										...
										<tr>
											<TD align="center" colspan="2"><h:outputLabel
													value="#{groupingOfUnmappedAction_20_21.distillery_nm}"
										...
										<TR>
											<TD align="center" colspan="2"><h:outputLabel
													value="#{groupingOfUnmappedAction_20_21.distillery_adrs}"
						...
						<TR>
							...
							<td><h:outputText value="License No"></h:outputText> <h:selectOneMenu
									value="#{groupingOfUnmappedAction_20_21.select_lic_no}"
									onchange="this.form.submit();">
									<f:selectItems value="#{groupingOfUnmappedAction_20_21.licno}" />
								</h:selectOneMenu></td>
						</tr>
						</TR>
						<TR>
							<TD><rich:dataTable columnClasses="columnClass1"
									...
									value="#{groupingOfUnmappedAction_20_21.showDataTableList}"
									var="list">
										...
										<td width="100%"><div class="panel-footer clearfix">
												<div align="center">
													...
													<h:commandButton class="btn btn-primary"
														action="#{groupingOfUnmappedAction_20_21.checkList}"
														value="Save"
													...
													<h:commandButton class="btn btn-default"
														action="#{groupingOfUnmappedAction_20_21.reset}" value="Reset"></h:commandButton>
												</div>
											</div></td>
						...
						<TR>
							<TD><rich:dataTable columnClasses="columnClass1"
									...
									value="#{groupingOfUnmappedAction_20_21.savedDataTableList}"
									var="list11">
								...
								<!-- 	<rich:column>
									...
									<rich:column>
										...
										<h:commandButton
											action="#{groupingOfUnmappedAction_20_21.finalizeData}"
											...
											<f:setPropertyActionListener value="#{list11}"
												target="#{groupingOfUnmappedAction_20_21.bopd}" />
										</h:commandButton>
