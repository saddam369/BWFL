<ui:composition xmlns="http://www.w3.org/1999/xhtml"
	...
	<f:view>
		<h:form>
			...
			<div class="row">
				<div align="center">
					<h:outputText value="RollOver Stock For FL2 / CL2 / FL2B"
						style="font-weight: bold;font-size: 35px;font-family: cursive sans MS; ">
					</h:outputText>
					<h:inputHidden value="#{rollover_Stock_20_21_fl2_action.hidden}">
			...
			<h:panelGroup
				rendered="#{rollover_Stock_20_21_fl2_action.viewflg eq 'F'}">
				<div>
					<rich:dataTable columnClasses="columnClass1" rows="10"
						headerClass="TableHead" footerClass="TableHead"
						rowClasses="TableRow1,TableRow2" styleClass="DataTable"
						id="table1" width="100%"
						value="#{rollover_Stock_20_21_fl2_action.displaylist}" var="list">
						<rich:column>
							<f:facet name="header">
						...
						<rich:column>
							...
							<center>
								...
								<h:commandButton value="Scan And Upload"
									...
									action="#{rollover_Stock_20_21_fl2_action.upload}"
									styleClass="btn btn-sm btn-success">
									<f:setPropertyActionListener value="#{list}"
										target="#{rollover_Stock_20_21_fl2_action.prt}" />
								</h:commandButton>
								<h:commandButton value="Freeze And Send To DEO"
									rendered="#{list.finl_flg and !list.com_flg}"
									action="#{rollover_Stock_20_21_fl2_action.freez}"
									styleClass="btn btn-sm btn-success"
				...
				<h:panelGroup
					rendered="#{rollover_Stock_20_21_fl2_action.viewflg eq 'T'}">
					...
					<div class="col-md-12" align="center">
						...
						<div class="col-md-9" align="left">
							<h:inputText value="#{rollover_Stock_20_21_fl2_action.brand_nm}"
					...
					<div class="col-md-12" align="center">
						...
						<div class="col-md-3" align="left">
							<h:inputText value="#{rollover_Stock_20_21_fl2_action.etn}"
								style="COLOR: #0000ff;" readonly="true"
								styleClass="form-control"></h:inputText>
						...
						<div class="col-md-3" align="left">
							<h:inputText value="#{rollover_Stock_20_21_fl2_action.rollerboxses}"
								style="COLOR: #0000ff;" readonly="true"
								styleClass="form-control"></h:inputText>
					...
					<div class="col-md-12" align="center">
						...
						<div class="col-md-4" align="left">
							<rich:fileUpload addControlLabel="Add File" id="link34"
								fileUploadListener="#{rollover_Stock_20_21_fl2_action.uploadCsv}"
						...
						<div class="col-md-4" align="right">
							<h:commandButton value="Upload CSV" styleClass="btn btn-primary"
								action="#{rollover_Stock_20_21_fl2_action.csvSubmit}">
							</h:commandButton>
					...
					<div>
						<rich:dataTable columnClasses="columnClass1" rows="10"
							...
							value="#{rollover_Stock_20_21_fl2_action.csvdetail}" var="list">
...
<div align="center">
						<h:commandButton action="#{rollover_Stock_20_21_fl2_action.reset}"
							styleClass="btn btn-sm btn-default " value="Close Uploading">
						</h:commandButton>
						<rich:spacer width="20px" />
						<h:commandButton action="#{rollover_Stock_20_21_fl2_action.save}" disabled="#{rollover_Stock_20_21_fl2_action.save_disable}" 
							styleClass="btn btn-sm btn-primary " value="Save and Finalize">
						</h:commandButton>
						<rich:spacer width="20px" />
						<h:commandButton
							action="#{rollover_Stock_20_21_fl2_action.delete}"
