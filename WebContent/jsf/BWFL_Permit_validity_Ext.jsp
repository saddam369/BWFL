			...
			<div class="panel panel-default">
				<div class="panel-body">
									...
									<TBODY>
										<TR align="center">
											...
											<TD align="center" width="100%" class="pghead"><h:inputHidden
												...
												<h2>
													<h:outputText value="  Permit Validity Extenstion "
					...
					<rich:dataTable align="center" styleClass="table-responsive"
						...
						value="#{bWFLImportAction.displayDataListExt}" var="list2"
						...
						<rich:column>
							...
							actionListener="#{bWFLImportAction.updateValidDate}" value="Update"
							onclick="submit">
							</h:commandButton>
						</rich:column>
						...
						<rich:column>
							...
							action="#{bWFLImportAction.rePrint}" value="Print And Digital Sign"
							onclick="submit">
							<f:setPropertyActionListener target="#{bWFLImportAction.bwflImportDataTable }" value="#{list2}" />
							</h:commandButton>
							...
							<h:outputLink
											...
											<f:param name="bwfl_id" value="#{list2.digital_sign_bwflID_dt}"></f:param>
