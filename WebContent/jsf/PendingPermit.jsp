	...
	border: 1px solid #669999;
		...
		<h:form>
			<div class="container">
					...
					<div class="row" align="center">
						<div class="col-md-12">
							<rich:dataTable id="table22" rows="10" width="100%"
								...
								<rich:column rendered="#{pendingPermitAction.radioType ne 'R'}">
									<f:facet name="header">
										<h:outputText value="ImportFee Challan No." />
									</f:facet>
									<center>
										<h:outputText styleClass="generalExciseStyle"
											value="#{list.importFeeChalanNo_dt}" />
									</center>
								</rich:column>

								<rich:column rendered="#{pendingPermitAction.radioType ne 'R'}">
									<f:facet name="header">
										<h:outputText value="SpecialFee Challan No." />
									</f:facet>
									<center>
										<h:outputText styleClass="generalExciseStyle"
											value="#{list.spclFeeChalanNo_dt}" />
									</center>
								</rich:column>
				...
				<h:panelGroup
					rendered="#{pendingPermitAction.radioType ne 'R' and pendingPermitAction.viewPanelFlg}">
