<ui:composition xmlns="http://www.w3.org/1999/xhtml"
	...
	<f:view>
		<h:form>
			...
			<div class="row">
				<div align="center">
					<h:outputText value="RollOver Stock "
						style="font-weight: bold;font-size: 35px;font-family: cursive sans MS; ">
					</h:outputText>
					<h:inputHidden value="#{rollOverStockNonRenewedBrandDeoAction.hidden}">
			...
			<h:panelGroup>
				...
				<div class="col-md-12" align="center">
					...
					<div class="row" align="center">
						<div class="col-md-12" align="center">
							...
							<div class="col-md-3" align="left">
								<h:selectOneMenu 
									value="#{rollOverStockNonRenewedBrandDeoAction.unitID}"
									style=" width : 350px;"
									valueChangeListener="#{rollOverStockNonRenewedBrandDeoAction.unitChngListener}"
									onchange="this.form.submit()">
									<f:selectItems
										value="#{rollOverStockNonRenewedBrandDeoAction.unitList}" />
								</h:selectOneMenu>
							</div>
					...
					<rich:dataTable columnClasses="columnClass1"  align="center"
						...
						id="table1" width="95%"
						value="#{rollOverStockNonRenewedBrandDeoAction.displaylist}"
						var="list">
						<rich:column>
							<f:facet name="header">
						...
						<rich:column rendered="#{rollOverStockNonRenewedBrandDeoAction.radio_type ne 'BWFL' }">
							<f:facet name="header">
						...
						disabled="#{rollOverStockNonRenewedBrandDeoAction.viewflg eq 'T' }"/>
						
						<h:commandButton value="Generate Excel" action="#{rollOverStockNonRenewedBrandDeoAction.generateExcel }"  rendered="#{list.checkbox_flg eq 'T'}" 
						...
						<f:setPropertyActionListener target="#{rollOverStockNonRenewedBrandDeoAction.deoDt}" value="#{list}" />
						</h:commandButton>
			...
			<div align="right">
				<h:commandButton value="Calculate Fees"
						styleClass="btn btn-sm  btn-success" disabled="#{rollOverStockNonRenewedBrandDeoAction.viewflg eq 'T' }"
						action="#{rollOverStockNonRenewedBrandDeoAction.calculate_fees}">
					</h:commandButton>
					</div>
			</h:panelGroup>
			<div class="row" align="center">
			...
			<h:panelGroup rendered="#{rollOverStockNonRenewedBrandDeoAction.viewflg eq 'T' }">
				<div class="col-md-12">
					...
					<div class="col-md-3" align="left">
						<h:inputText styleClass="inputtext" disabled="true"
							value="#{rollOverStockNonRenewedBrandDeoAction.total_mrp}" >
							<f:convertNumber maxFractionDigits="2"
										pattern="#############0.00" />
						</h:inputText>
					...
					<div class="col-md-2" align="right">
						<h:outputLabel rendered="#{rollOverStockNonRenewedBrandDeoAction.radio_type ne 'BWFL' }"
						value="Total Duty:" style="FONT-WEIGHT: bold;"></h:outputLabel>
					</div>

					<div class="col-md-3" align="left">
						<h:inputText styleClass="inputtext" disabled="true" rendered="#{rollOverStockNonRenewedBrandDeoAction.radio_type ne 'BWFL' }"
							value="#{rollOverStockNonRenewedBrandDeoAction.total_duty}">
							<f:convertNumber maxFractionDigits="2"
										pattern="#############0.00" />
						</h:inputText>
					</div>
					...
					<div class="col-md-12">
						...
						<div class="col-md-12" align="center">
							...
							<rich:dataTable columnClasses="columnClass1"
								...
								value="#{rollOverStockNonRenewedBrandDeoAction.challantable}" var="list">
								<rich:column>
									<f:facet name="header">
...
<rich:column>
								...
								<rich:column>
									<f:facet name="header">
										<h:commandButton class="imag"
											action="#{rollOverStockNonRenewedBrandDeoAction.addRowMethod}"
											image="/img/add.png" />
									</f:facet>
									<center>
										<h:commandButton class="imag"
											actionListener="#{rollOverStockNonRenewedBrandDeoAction.deleteRowMethodlabel}"
				...
				<h:commandButton value="Reject" disabled="true"
						...
						action="#{rollOverStockNonRenewedBrandDeoAction.dfinalize}">
					</h:commandButton>
					<rich:spacer width="20px" />
					<h:commandButton value="Approve"
						styleClass="btn btn-sm  btn-success" 
						action="#{rollOverStockNonRenewedBrandDeoAction.finalizeData}">
					</h:commandButton>
					<rich:spacer width="20px" />
					<h:commandButton action="#{rollOverStockNonRenewedBrandDeoAction.reset}"
