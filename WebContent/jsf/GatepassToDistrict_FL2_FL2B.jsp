				...
				<div class="panel-body">
					<TABLE width="100%" align="center">
						...
						<TR align="center" style="FONT-SIZE: x-large; FONT-WEIGHT: bold;">
							<TD><h:inputHidden
									value="#{gatepassToDistrict_FL2_FL2B_Action.hidden}"></h:inputHidden>
								<h5>
									<h:outputText value="GatePass To Retailer FL2 / FL2B / CL2 2019-20"
								...
								<TABLE width="100%" align="center">
									...
									<tr>
										<TD align="center" colspan="2"><h:outputLabel
												value="#{gatepassToDistrict_FL2_FL2B_Action.fl2_fl2bName}"
									...
									<TR>
										...
										<TD align="center" colspan="2"><h:outputLabel
												value="#{gatepassToDistrict_FL2_FL2B_Action.fl2_fl2bAdrs}"
												...
												<TBODY align="center">
													...
													<tr>
														<TD colspan="2" align="center">Date : <rich:calendar
																disabled="true"
																value="#{gatepassToDistrict_FL2_FL2B_Action.dt_date}" />
														</TD>
														<TD colspan="2" align="center">Valid Till : <rich:calendar
																value="#{gatepassToDistrict_FL2_FL2B_Action.validtilldt_date}" />
														</TD>
													</tr>
													<tr>
														<TD><rich:spacer height="10px"></rich:spacer></TD>
													...
													<tr align="center">
														...
														<TD align="left"><h:outputText
																value="#{gatepassToDistrict_FL2_FL2B_Action.vch_from}" /></TD>
													...
													<tr align="center">
														...
														<TD align="left"><h:selectOneRadio
																value="#{gatepassToDistrict_FL2_FL2B_Action.vch_to}"
																rendered="#{gatepassToDistrict_FL2_FL2B_Action.brcFlag}"
																valueChangeListener="#{gatepassToDistrict_FL2_FL2B_Action.listMethod}"
																...
																value="#{gatepassToDistrict_FL2_FL2B_Action.vch_to}"
																rendered="#{gatepassToDistrict_FL2_FL2B_Action.rtFlag}"
																valueChangeListener="#{gatepassToDistrict_FL2_FL2B_Action.listMethod}"
																onchange="this.form.submit()">
														...
														<td align="right" style="padding-right: 10px;"><h:outputText
																value="HBR-"
																rendered="#{gatepassToDistrict_FL2_FL2B_Action.vch_to eq 'BRC'}"
																style="FONT-SIZE: small; FONT-WEIGHT: bold;">
															</h:outputText> <h:outputText value="Shop Id."
																rendered="#{gatepassToDistrict_FL2_FL2B_Action.vch_to eq 'RT'}"
																style="FONT-SIZE: small; FONT-WEIGHT: bold;">
															</h:outputText></td>
														<td align="left"><h:inputText
																value="#{gatepassToDistrict_FL2_FL2B_Action.vch_to_lic_no}"
																rendered="#{gatepassToDistrict_FL2_FL2B_Action.vch_to eq 'BRC' }"
															...
															<h:outputLabel
																rendered="#{gatepassToDistrict_FL2_FL2B_Action.vch_to eq 'BRC' }">*Enter only digits w/o HBR.</h:outputLabel>
															<h:inputText
																value="#{gatepassToDistrict_FL2_FL2B_Action.shopno}"
																rendered="#{gatepassToDistrict_FL2_FL2B_Action.vch_to eq 'RT'}"
																styleClass="generalHeaderOutputTable"
																style="width:250px">
														...
														<td align="left"><h:commandButton
																...
																rendered="#{gatepassToDistrict_FL2_FL2B_Action.vch_to  eq 'BRC' and !gatepassToDistrict_FL2_FL2B_Action.disable_flag}"
																action="#{gatepassToDistrict_FL2_FL2B_Action.fetch1}"
																value="Validate"></h:commandButton> <h:commandButton
																styleClass="btn btn-primary"
																rendered="#{gatepassToDistrict_FL2_FL2B_Action.vch_to  eq 'RT' and !gatepassToDistrict_FL2_FL2B_Action.disable_flag}"
																action="#{gatepassToDistrict_FL2_FL2B_Action.fetch}"
													...
													<tr style="padding-bottom: 10px;">
														...
														<td align="left"><h:selectOneMenu rendered="false"
																value="#{gatepassToDistrict_FL2_FL2B_Action.districtLic}"
																style="width: 250px; height: 28px;">
																<f:selectItems
																	value="#{gatepassToDistrict_FL2_FL2B_Action.districtList}" />
															</h:selectOneMenu></td>
														<td align="right"><h:outputText value="Shop Name."
																rendered="#{gatepassToDistrict_FL2_FL2B_Action.flagshop}"
																style="FONT-SIZE: small; FONT-WEIGHT: bold;">
															</h:outputText></td>
														<td align="left"><h:inputText disabled="true"
																value="#{gatepassToDistrict_FL2_FL2B_Action.shopName}"
																rendered="#{gatepassToDistrict_FL2_FL2B_Action.flagshop}"
																styleClass="generalHeaderOutputTable"
																style="width:250px">
													...
													<tr style="padding-bottom: 10px;">
														...
														<td align="left"><h:inputText
																value="#{gatepassToDistrict_FL2_FL2B_Action.licenseeName}"
																styleClass="generalHeaderOutputTable"
														...
														<td align="left"><h:inputTextarea
																value="#{gatepassToDistrict_FL2_FL2B_Action.licenseeAdrs}"
																styleClass="generalHeaderOutputTable"
																style="width: 250px;" disabled="true">
													...
													<tr style="padding-bottom: 10px;">
														...
														<td align="left"><h:inputTextarea
																value="#{gatepassToDistrict_FL2_FL2B_Action.routeDtl}"
																styleClass="generalHeaderOutputTable"
																style="width: 250px;">
														...
														<td align="left"><h:inputText
																value="#{gatepassToDistrict_FL2_FL2B_Action.vehicleNo}"
																styleClass="generalHeaderOutputTable"
																style="width:250px">
													...
													<tr style="padding-bottom: 10px;">
														...
														<td align="left"><h:inputText
																value="#{gatepassToDistrict_FL2_FL2B_Action.vehicleDrvrName}"
																styleClass="generalHeaderOutputTable"
																style="width:250px">
														...
														<td align="left"><h:inputTextarea
																value="#{gatepassToDistrict_FL2_FL2B_Action.vehicleAgencyNmAdrs}"
																styleClass="generalHeaderOutputTable"
																style="width: 250px;">
													...
													<tr style="padding-bottom: 10px;">
														...
														<td align="left"><h:selectOneMenu rendered="false"
																value="#{gatepassToDistrict_FL2_FL2B_Action.district1}"
																style="width: 250px; height: 28px;">
																<f:selectItems
																	value="#{gatepassToDistrict_FL2_FL2B_Action.districtList}" />
															</h:selectOneMenu></td>
														...
														<td align="left"><h:selectOneMenu rendered="false"
																value="#{gatepassToDistrict_FL2_FL2B_Action.district2}"
																style="width: 250px; height: 28px;">
																<f:selectItems
																	value="#{gatepassToDistrict_FL2_FL2B_Action.districtList}" />
															</h:selectOneMenu></td>
														...
														<td align="left"><h:selectOneMenu rendered="false"
																value="#{gatepassToDistrict_FL2_FL2B_Action.district3}"
																style="width: 250px; height: 28px;">
																<f:selectItems
																	value="#{gatepassToDistrict_FL2_FL2B_Action.districtList}" />
															</h:selectOneMenu></td>
													...
													<tr style="padding-bottom: 10px; padding-top: 10px;">
														...
														<TD align="left"
															style="FONT-WEIGHT: bold; padding-right: 10px;"><h:outputText
																...
																style="FONT-SIZE: small; FONT-WEIGHT: bold;"
																rendered="#{gatepassToDistrict_FL2_FL2B_Action.vch_to eq 'BRC'}"></h:outputText>
															<h:inputText
																value="#{gatepassToDistrict_FL2_FL2B_Action.challan_no}"
																styleClass="generalHeaderOutputTable"
																style="width:250px"
																rendered="#{gatepassToDistrict_FL2_FL2B_Action.vch_to eq 'BRC'}">
															</h:inputText></TD>
														...
														<td align="left"
															style="FONT-WEIGHT: bold; padding-right: 10px;"><rich:calendar
																value="#{gatepassToDistrict_FL2_FL2B_Action.challan_dt}"
																style="width:250px"
																rendered="#{gatepassToDistrict_FL2_FL2B_Action.vch_to eq 'BRC'}" />
														</td>
													...
													<tr style="padding-bottom: 10px; padding-top: 10px;">
														...
														<TD align="left"
															style="FONT-WEIGHT: bold; padding-right: 10px;"><h:outputText
																...
																rendered="#{gatepassToDistrict_FL2_FL2B_Action.vch_to eq 'BRC'}"></h:outputText>
															<h:inputText
																value="#{gatepassToDistrict_FL2_FL2B_Action.challan_amt}"
																styleClass="generalHeaderOutputTable"
																style="width:250px"
																rendered="#{gatepassToDistrict_FL2_FL2B_Action.vch_to eq 'BRC'}">
															</h:inputText></TD>
									...
									value="#{gatepassToDistrict_FL2_FL2B_Action.displaylist}"
									var="list">
						...
						<tr>
							<td style="text-align: center;"><h:commandButton
									styleClass="btn btn-primary"
									action="#{gatepassToDistrict_FL2_FL2B_Action.saveMethod}"
								...
								<rich:spacer width="10px"></rich:spacer> <h:commandButton
									styleClass="btn btn-warning" rendered="false"
									action="#{gatepassToDistrict_FL2_FL2B_Action.clearAll}"
					...
					<div class="row">
						...
						<rich:calendar
							valueChangeListener="#{gatepassToDistrict_FL2_FL2B_Action.listMethod1}"
							onchanged="this.form.submit();"
							value="#{gatepassToDistrict_FL2_FL2B_Action.table_dt}" />

					</div>
					<div class="row">
						<rich:dataTable align="center" id="table55" rows="10" width="100%"
							var="list11"
							value="#{gatepassToDistrict_FL2_FL2B_Action.table2List }"
							headerClass="TableHead" footerClass="TableHead"
							...
							<rich:column>
								...
								<center>
									...
									<h:commandButton styleClass="btn btn-success"
										...
										actionListener="#{gatepassToDistrict_FL2_FL2B_Action.printDraft}"></h:commandButton>
									...
									<h:commandButton styleClass="btn btn-success" value="Print"
										...
										actionListener="#{gatepassToDistrict_FL2_FL2B_Action.printReport }"></h:commandButton>

									<h:outputLink styleClass="outputLinkEx"
										value="/doc/ExciseUp/WholeSale/pdf//#{gatepassToDistrict_FL2_FL2B_Action.pdfname}"
										target="_blank">
									...
									<h:outputLink styleClass="outputLinkEx"
										value="/doc/ExciseUp/WholeSale/pdf//#{gatepassToDistrict_FL2_FL2B_Action.pdfname_CaseCode}"
										target="_blank">
									...
									<h:commandButton styleClass="btn btn-success"
										...
										actionListener="#{gatepassToDistrict_FL2_FL2B_Action.scanAndUpload}"></h:commandButton>
							...
							<rich:column>
								...
								<center>
									<h:commandButton value="Cancel Gatepass"
										...
										actionListener="#{gatepassToDistrict_FL2_FL2B_Action.cancelGatepass}">
									</h:commandButton>
								</center>
							</rich:column>
						...
						<table align="center">
							...
							<tr>
								<td colspan="6" style="color: Green;" align="left"><h:outputText
										rendered="#{gatepassToDistrict_FL2_FL2B_Action.scanUploadFlag}"
							...
							<tr align="left">
								...
								<td style="FONT-SIZE: large; color: Red"><h:outputText
										value="#{gatepassToDistrict_FL2_FL2B_Action.scanGatePassNo}"
										rendered="#{gatepassToDistrict_FL2_FL2B_Action.scanUploadFlag}"
								...
								<TD><h:outputLink value="/doc/ExciseUp/ExcelFormatFCL.pdf"
										...
										<h:graphicImage value="/img/i.png" style="width:40px;"
											rendered="#{gatepassToDistrict_FL2_FL2B_Action.scanUploadFlag }"></h:graphicImage>
									</h:outputLink></TD>
								...
								<td><rich:fileUpload addControlLabel="Add File" id="link34"
										fileUploadListener="#{gatepassToDistrict_FL2_FL2B_Action.uploadCsv}"
										rendered="#{gatepassToDistrict_FL2_FL2B_Action.scanUploadFlag and gatepassToDistrict_FL2_FL2B_Action.exclcsv eq 'C'}"
								...
								<td><h:commandButton value="Upload CSV"
										styleClass="btn btn-primary"
										rendered="#{gatepassToDistrict_FL2_FL2B_Action.scanUploadFlag and gatepassToDistrict_FL2_FL2B_Action.exclcsv eq 'C'}"
										action="#{gatepassToDistrict_FL2_FL2B_Action.csvSubmit }">
									</h:commandButton></td>
							</tr>
						</table>
						<div class="row">
							<div class="col-md-6 col-sm-6">
								<rich:dataTable align="center" id="table57" rows="10"
									width="100%" var="listk"
									rendered="#{gatepassToDistrict_FL2_FL2B_Action.scanUploadFlag}"
									value="#{gatepassToDistrict_FL2_FL2B_Action.getVal}"
									headerClass="TableHead" footerClass="TableHead"
									rowClasses="TableRow1,TableRow2">
							...
							<div class="col-md-6 col-sm-6">
								<rich:dataTable align="center" id="table58" rows="10"
									width="100%" var="listl"
									rendered="#{gatepassToDistrict_FL2_FL2B_Action.scanUploadFlag  }"
									value="#{gatepassToDistrict_FL2_FL2B_Action.sourceList}"
									headerClass="TableHead" footerClass="TableHead"
									rowClasses="TableRow1,TableRow2">
							...
							<table align="center">
								<tr>
									<td style="color: Red;" align="center" colspan="2"><h:outputText
											rendered="#{gatepassToDistrict_FL2_FL2B_Action.scanUploadFlag and gatepassToDistrict_FL2_FL2B_Action.fl2LicenseType eq 'CL2'}"
								...
								<tr>
									<td align="center"><h:commandButton value="Finalize"
											styleClass="btn btn-primary"
											rendered="#{gatepassToDistrict_FL2_FL2B_Action.scanUploadFlag}"
											action="#{gatepassToDistrict_FL2_FL2B_Action.finalSubmit}">

										</h:commandButton> <h:commandButton value="Clear Old Data"
											styleClass="btn btn-danger"
											rendered="#{gatepassToDistrict_FL2_FL2B_Action.scanUploadFlag}"
											action="#{gatepassToDistrict_FL2_FL2B_Action.delete}">
										</h:commandButton></td>
