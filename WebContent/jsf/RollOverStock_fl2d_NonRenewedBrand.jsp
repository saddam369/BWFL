	...
	<f:view>
		<h:form>
			...
			<div class="row">
				<div align="center">
					<h:outputText
						value="RollOver Of Non-Renewed Brand Stock For FL2D"
						style="font-weight: bold;font-size: 35px;font-family: cursive sans MS; ">
					</h:outputText>
					<h:inputHidden value="#{rollOverStock_fl2d_NonRenewedBrandAction.hidden}">
			...
			<h:panelGroup
				rendered="#{rollOverStock_fl2d_NonRenewedBrandAction.viewflg eq 'F'}">
				<div>
					<rich:dataTable columnClasses="columnClass1" rows="10"
						headerClass="TableHead" footerClass="TableHead"
						rowClasses="TableRow1,TableRow2" styleClass="DataTable"
						id="table1" width="100%"
						value="#{rollOverStock_fl2d_NonRenewedBrandAction.displaylist}" var="list">
						<rich:column>
							<f:facet name="header">
						...
						<rich:column>
							...
							<h:selectOneMenu value="#{list.etin_new}" disabled="#{list.finl_flg}">
						...
						<rich:column>
							...
							<center>
								...
								<h:commandButton value="Scan And Upload"
									...
									action="#{rollOverStock_fl2d_NonRenewedBrandAction.upload}"
									styleClass="btn btn-sm btn-success">
									<f:setPropertyActionListener value="#{list}"
										target="#{rollOverStock_fl2d_NonRenewedBrandAction.prt}" />
								</h:commandButton>
								<h:commandButton value="Freeze And Send To DEO"
									rendered="#{list.finl_flg and !list.com_flg}"
									action="#{rollOverStock_fl2d_NonRenewedBrandAction.freez}"
									styleClass="btn btn-sm btn-success"
			...
			<h:panelGroup
				rendered="#{rollOverStock_fl2d_NonRenewedBrandAction.viewflg eq 'T'}">
				...
				<div class="col-md-12" align="center">
					...
					<div class="col-md-9" align="left">
						<h:inputText value="#{rollOverStock_fl2d_NonRenewedBrandAction.brand_nm}"
				...
				<div class="col-md-12" align="center">
					...
					<div class="col-md-3" align="left">
						<h:inputText value="#{rollOverStock_fl2d_NonRenewedBrandAction.etn}"
							style="COLOR: #0000ff;" readonly="true" styleClass="form-control"></h:inputText>
					...
					<div class="col-md-3" align="left">
						<h:inputText
							value="#{rollOverStock_fl2d_NonRenewedBrandAction.rollerboxses}"
							style="COLOR: #0000ff;" readonly="true" styleClass="form-control"></h:inputText>
...
<div class="col-md-12" align="center">
					...
					<div class="col-md-3" align="left">
						<h:inputText value="#{rollOverStock_fl2d_NonRenewedBrandAction.new_etin}"
							style="COLOR: #0000ff;" readonly="true" styleClass="form-control"></h:inputText>
...
<div class="col-md-3" align="right">
					...
					<div class="col-md-9" align="left">
						<h:inputText value="#{rollOverStock_fl2d_NonRenewedBrandAction.new_brand_name}"
							style="COLOR: #0000ff;" readonly="true" styleClass="form-control"></h:inputText>
				...
				<div class="col-md-12" align="center">
					...
					<div class="col-md-4" align="left">
						<rich:fileUpload addControlLabel="Add File" id="link34"
							fileUploadListener="#{rollOverStock_fl2d_NonRenewedBrandAction.uploadCsv}"
					...
					<div class="col-md-4" align="right">
						<h:commandButton value="Upload CSV" styleClass="btn btn-primary"
							action="#{rollOverStock_fl2d_NonRenewedBrandAction.csvSubmit}">
						</h:commandButton>
				...
				<div>
					<rich:dataTable columnClasses="columnClass1" rows="10"
						...
						value="#{rollOverStock_fl2d_NonRenewedBrandAction.csvdetail}" var="list">
					...
					<div align="center">
						<h:commandButton action="#{rollOverStock_fl2d_NonRenewedBrandAction.reset}"
							styleClass="btn btn-sm btn-default " value="Close Uploading">
						</h:commandButton>
						<rich:spacer width="20px" />
						<h:commandButton action="#{rollOverStock_fl2d_NonRenewedBrandAction.save}"
							disabled="#{rollOverStock_fl2d_NonRenewedBrandAction.save_disable}"
							styleClass="btn btn-sm btn-primary " value="Save and Finalize">
						</h:commandButton>
						<rich:spacer width="20px" />
						<h:commandButton
							action="#{rollOverStock_fl2d_NonRenewedBrandAction.delete}"
