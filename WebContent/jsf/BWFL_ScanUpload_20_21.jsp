			...
			<div class="container">
				...
				<div class="row" align="center">
					<div class="col-md-12">
						...
						<h:inputHidden value="#{bWFL_ScanUploadAction_20_21.hidden}" />
					</div>
				</div>
				<br />
					...
					<TBODY align="center">
						...
						<tr align="center">
							...
							<TD align="left"><h:inputText
									value="#{bWFL_ScanUploadAction_20_21.distillery_name}"
							...
							<td align="left">
								<h:selectOneMenu
									valueChangeListener="#{bWFL_ScanUploadAction_20_21.licChangeLsnr}"
									value="#{bWFL_ScanUploadAction_20_21.select_lic_no}"
									onchange="this.form.submit();">
									<f:selectItems value="#{bWFL_ScanUploadAction_20_21.licno}" />
								</h:selectOneMenu>
							</td>
						</tr>
						<tr align="center">
						...
						<tr align="center">
							...
							<TD align="left"><h:selectOneRadio
									value="#{bWFL_ScanUploadAction_20_21.license_type}" disabled="true">
							...
							<td align="right" style="padding-right: 10px;"><h:outputText
									...
									style="FONT-SIZE: small; FONT-WEIGHT: bold;"></h:outputText></td>
							<td align="left"><h:inputText
									value="#{bWFL_ScanUploadAction_20_21.licensee_name}"
									styleClass="generalHeaderOutputTable" style="width:250px"
									disabled="true">
						...
						<tr style="padding-bottom: 10px;">
							...
							<td align="left"><h:inputTextarea
									value="#{bWFL_ScanUploadAction_20_21.firm_address}"
									styleClass="generalHeaderOutputTable" style="width: 250px;"
									disabled="true">
						...
						<tr style="padding-bottom: 10px;">
							<TD align="right" style="FONT-WEIGHT: bold; padding-right: 10px;"><h:outputText
									...
									style="FONT-SIZE: small; FONT-WEIGHT: bold;"></h:outputText></TD>
							<td align="left"><h:inputTextarea
									value="#{bWFL_ScanUploadAction_20_21.routeDetails}"
									styleClass="generalHeaderOutputTable" style="width: 250px;">
							...
							<TD align="right" style="padding-right: 10px;"><h:outputText
									...
									style="FONT-SIZE: small; FONT-WEIGHT: bold;"></h:outputText></TD>
							<td align="left"><h:inputText
									value="#{bWFL_ScanUploadAction_20_21.transVehicleNo}"
									styleClass="generalHeaderOutputTable" style="width:250px">
						...
						<tr style="padding-bottom: 10px;">
							<TD align="right" style="FONT-WEIGHT: bold; padding-right: 10px;"><h:outputText
									...
									style="FONT-SIZE: small; FONT-WEIGHT: bold;"></h:outputText></TD>
							<td align="left"><h:inputText
									value="#{bWFL_ScanUploadAction_20_21.expOrderNo}"
									styleClass="generalHeaderOutputTable" style="width:250px">
							...
							<td align="left"><rich:calendar
									...
									value="#{bWFL_ScanUploadAction_20_21.expOrderDt}" /></td>
						</tr>
						<tr align="center">
							<td style="padding-top: 10px;"></td>
						</tr>
				...
				<h:panelGroup>
					<rich:dataTable align="center" styleClass="table-responsive"
						...
						value="#{bWFL_ScanUploadAction_20_21.datalist}" var="list1"
						...
						<rich:column id="column6">
							...
							<center>
								<h:outputText styleClass="generalExciseStyle"
									value="#{list1.scanning_fee}" />
							</center>
						</rich:column>
						<rich:column id="column8">
							<f:facet name="header">
								<h:outputText value="Special Add Consideration Fee"
									styleClass="generalHeaderStyle" />
							</f:facet>
							<center>
								<h:outputText styleClass="generalExciseStyle"
						...
						<rich:column>
							...
							<center>
								...
								<h:commandButton value="Save"
									...
									actionListener="#{bWFL_ScanUploadAction_20_21.updateData}"
						...
						<div class="col-md-12">
							<center>
								...
								<h:commandButton value="Reset" styleClass="btn btn-danger"
									action="#{bWFL_ScanUploadAction_20_21.reset}" />
					...
					<rich:dataTable align="center" styleClass="table-responsive"
						...
						value="#{bWFL_ScanUploadAction_20_21.reciept_list}" var="list2"
						style="FONT-FAMILY: 'Baskerville Old Face';"
						headerClass="TableHead" footerClass="TableHead"
						rowClasses="TableRow1,TableRow2">
						...
						<rich:column>
							...
							<center>
								<h:commandButton styleClass="btn btn-success" value="Print"
									...
									actionListener="#{bWFL_ScanUploadAction_20_21.printreport}" />

								<h:outputLink styleClass="outputLinkEx"
									value="/doc/ExciseUp/WholeSale/pdf//#{bWFL_ScanUploadAction_20_21.pdfName}"
									target="_blank">
								...
								<h:commandButton styleClass="btn btn-success"
									...
									actionListener="#{bWFL_ScanUploadAction_20_21.scanAndUpload}">
								</h:commandButton>
					...
					<table align="center">
						<tr>
							<td colspan="6" style="color: Green;" align="left"><h:outputText
									rendered="#{bWFL_ScanUploadAction_20_21.gatePassFlag}"
						...
						<tr align="left">
							...
							<td style="FONT-SIZE: large; color: Red"><h:outputText
									rendered="#{bWFL_ScanUploadAction_20_21.gatePassFlag}"
									value="#{bWFL_ScanUploadAction_20_21.gatepassForCsv}"
							...
							<td><rich:fileUpload addControlLabel="Add File" id="link3"
									fileUploadListener="#{bWFL_ScanUploadAction_20_21.uploadCsv}"
									rendered="#{bWFL_ScanUploadAction_20_21.gatePassFlag}"
							...
							<td><h:commandButton value="Upload"
									styleClass="btn btn-primary"
									rendered="#{bWFL_ScanUploadAction_20_21.gatePassFlag}"
									action="#{bWFL_ScanUploadAction_20_21.csvSubmit}">
								</h:commandButton></td>
					...
					<div>
						<rich:dataTable align="center" id="table57" rows="10" width="100%"
							var="listk" value="#{bWFL_ScanUploadAction_20_21.getVal}"
							rendered="#{bWFL_ScanUploadAction_20_21.tableFlag}"
							headerClass="TableHead" footerClass="TableHead"
							rowClasses="TableRow1,TableRow2">
					...
					<div class="col-md-12">
						<center>
							<h:commandButton value="Finalize"
								...
								rendered="#{bWFL_ScanUploadAction_20_21.tableFlag}"
								action="#{bWFL_ScanUploadAction_20_21.finalSubmit}"
								disabled="#{bWFL_ScanUploadAction_20_21.bottlingNotDoneFlag }"
								styleClass="btn btn-primary" />
							<rich:spacer width="30px"></rich:spacer>

							<h:commandButton value="Cancel" styleClass="btn btn-danger"
								rendered="#{bWFL_ScanUploadAction_20_21.tableFlag}"
								action="#{bWFL_ScanUploadAction_20_21.delete}">
							</h:commandButton>
