				...
				<div class="panel-body">
					<TABLE width="100%" align="center">
						...
						<TR align="center" style="FONT-SIZE: x-large; FONT-WEIGHT: bold;">
							<TD><h:inputHidden value="#{stock_FL2_FL2B_activeAction.hidden}"></h:inputHidden>
								<h5>
									<h:outputText value="FL2 / 2B / CL2 STOCK RECEIVING 2020-21"
								...
								<TABLE width="100%" align="center">
									...
									<tr>
										<TD align="center" colspan="2"><h:outputLabel
												value="#{stock_FL2_FL2B_activeAction.name}"
									...
									<TR>
										...
										<TD align="center" colspan="2"><h:outputLabel
												value="#{stock_FL2_FL2B_activeAction.address}"
												...
												<TBODY align="center">
													...
													<tr>
														<TD colspan="4" align="center"><h:selectOneRadio
																style="width:20%;" value="#{stock_FL2_FL2B_activeAction.oldnew}">
																 
																<f:selectItem itemValue="N" itemLabel="New Stock" />
															</h:selectOneRadio> <h:selectOneRadio style="width:40%;"
																value="#{stock_FL2_FL2B_activeAction.licenseing}" >


																<f:selectItem itemValue="D" itemLabel="Distillery" />
																<f:selectItem itemValue="B" itemLabel="Brewery"
																	itemDisabled="#{stock_FL2_FL2B_activeAction.loginType eq 'CL2'}" />
													...
													<tr>
														<TD colspan="2" align="center">GatePass No : <h:inputText
																value="#{stock_FL2_FL2B_activeAction.gatePassNo}" />

														</TD>
														<TD colspan="2" align="center">Issue Gatepass Date :
															<rich:calendar value="#{stock_FL2_FL2B_activeAction.createdDate}"
															  />
														</TD>
													</tr>
													...
													<tr align="center">
														...
														<TD align="center" colspan="2"><h:commandButton
																action="#{stock_FL2_FL2B_activeAction.check}" value="Get Details"
									...
									id="table3" width="100%"
									value="#{stock_FL2_FL2B_activeAction.gatePssDisplaylist}" var="list">
						...
						<tr>
							<td style="text-align: center;"><h:commandButton
									...
									action="#{stock_FL2_FL2B_activeAction.saveMethod}" value="Save"
								...
								<rich:spacer width="10px"></rich:spacer> <h:commandButton
									...
									action="#{stock_FL2_FL2B_activeAction.reset}" value="Reset"></h:commandButton></td>
						</tr>
						...
						<tr>
							<td><rich:dataTable align="center" id="table55" rows="10"
									...
									value="#{stock_FL2_FL2B_activeAction.show_Data_table}"
									headerClass="TableHead" footerClass="TableHead"
