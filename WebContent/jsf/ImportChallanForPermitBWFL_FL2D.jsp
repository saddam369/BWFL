	...
	<f:view>
		<h:form>
			...
			<rich:spacer height="30px;"></rich:spacer>
				...
				<div align="center">
					<h:inputHidden
						value="#{importChallanForPermitBWFL_FL2DAction.hidden}"></h:inputHidden>
				...
				<div align="center">
					<rich:dataTable id="table" style="background: #0000"  
						width="90%" var="list"
						value="#{importChallanForPermitBWFL_FL2DAction.datalist}"
...
<div class="col-sm-1" ></div>
					<div class="col-sm-5" align="left">
						...
						<h:selectOneMenu
							value="#{importChallanForPermitBWFL_FL2DAction.import_fee_challan_no}"
							style=" white-space: normal;width : 200px; height: 21px;">
							<f:selectItems
								value="#{importChallanForPermitBWFL_FL2DAction.importChallanList}" />
						</h:selectOneMenu>
					</div>
					<div class="col-sm-5" align="left">
						<h:outputText value="Special Fee Challan No: "
							style="FONT-WEIGHT: bold;" />
						<h:selectOneMenu
							value="#{importChallanForPermitBWFL_FL2DAction.spcl_fee_challan_no}"
							style=" white-space: normal;width : 200px; height: 21px;">
							<f:selectItems
								value="#{importChallanForPermitBWFL_FL2DAction.spclChallanList}" />
						</h:selectOneMenu>
					</div>
				...
				<h:commandButton value="Back" styleClass="btn btn-success"
						action="#{importChallanForPermitBWFL_FL2DAction.navigationBack}"
						style="color:#FFFFFF; background-color: #253f8a;">
					</h:commandButton>
				
					<h:commandButton value="Save" class="btn btn-info"
						action="#{importChallanForPermitBWFL_FL2DAction.save}"
						style="color:#FFFFFF; background-color: #253f8a;">
					</h:commandButton>
				</div>
				<rich:spacer height="30px;"></rich:spacer>
