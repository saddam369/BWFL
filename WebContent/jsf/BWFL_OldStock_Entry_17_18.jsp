									...
									<TBODY>
										<TR align="center">
											...
											<TD align="center" width="100%" class="pghead"><h:inputHidden
													value="#{bWFL_OldStock_Entry_17_18Action.hidden}"></h:inputHidden>
												<h2>
										...
										<tr>
											<TD align="center" colspan="2"><h:outputLabel
													value="#{bWFL_OldStock_Entry_17_18Action.distillery_nm}"
										...
										<TR>
											<TD align="center" colspan="2"><h:outputLabel
													value="#{bWFL_OldStock_Entry_17_18Action.distillery_adrs}"
										...
										<TABLE width="80%">
											<TBODY>
												...
												<TR>
													...
													<TD><h:selectOneMenu value="#{bWFL_OldStock_Entry_17_18Action.licenceType }" 
													styleClass="dropdown-menu"   valueChangeListener="#{bWFL_OldStock_Entry_17_18Action.licencelistener}" 
...
<TD width="150px"><h5>
													...
													<TD><h:selectOneMenu
															value="#{bWFL_OldStock_Entry_17_18Action.licenceNoId }"
															styleClass="dropdown-menu" onchange="this.form.submit();"
															valueChangeListener="#{bWFL_OldStock_Entry_17_18Action.getaddrowdata}">

															<f:selectItems
																value="#{bWFL_OldStock_Entry_17_18Action.licenceNoList}" />
														</h:selectOneMenu></TD>
											...
											<tbody>
												...
												<TR>
													<TD><rich:dataTable columnClasses="columnClass1"
															...
															value="#{bWFL_OldStock_Entry_17_18Action.brandPackagingDataList}"
															var="list">
															<rich:column>
																<f:facet name="header">
															...
															<f:facet name="header">
																<h:commandButton class="imag"
																	action="#{bWFL_OldStock_Entry_17_18Action.addRowMethodPackaging}"
																	image="/img/add.png"/>
															</f:facet>
															<h:commandButton class="imag"
																actionListener="#{bWFL_OldStock_Entry_17_18Action.deleteRowMethodPackaging}"
										...
										<td width="100%"><div class="panel-footer clearfix">
												<div align="center">
													...
													<h:commandButton class="btn btn-primary"
														action="#{bWFL_OldStock_Entry_17_18Action.save}" value="Save" />

													<rich:spacer width="10px"></rich:spacer>
													<h:commandButton class="btn btn-default"
														action="#{bWFL_OldStock_Entry_17_18Action.reset}" value="Reset"></h:commandButton>
												</div>
											</div></td>
									...
									<TBODY>
										<TR>
											<TD><rich:dataTable columnClasses="columnClass1"
													...
													value="#{bWFL_OldStock_Entry_17_18Action.showDataTableList}"
													var="list">
													...
													<rich:column>
														...
														<h:commandButton
															action="#{bWFL_OldStock_Entry_17_18Action.finalizeData}"
															...
															<f:setPropertyActionListener value="#{list}"
																target="#{bWFL_OldStock_Entry_17_18Action.bopd }" />
														</h:commandButton>



														<h:outputLink target="_blank"
															value="/doc/ExciseUp/Excel/OLDSTOCKBWFL#{list.gtinno}#{list.finalizedDateString}#{list.seq}.xls">
