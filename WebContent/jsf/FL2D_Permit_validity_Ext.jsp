			...
			<div class="panel panel-default">
				<div class="panel-body">
									...
									<TBODY>
										<TR align="center">
											...
											<TD align="center" width="100%" class="pghead">
												<h2>
													<h:outputText value=" FL2D Permit Validity Extenstion "
					...
					<rich:dataTable align="center" styleClass="table-responsive"
						...
						value="#{fL2D_Permit_validity_ExtAction.displayDataListExt}" var="list2"
						...
						<rich:column>
							...
							actionListener="#{fL2D_Permit_validity_ExtAction.updateValidDate}" value="Update"
							onclick="submit">
							</h:commandButton>
						...
						<rich:column>
							...
							action="#{fL2D_Permit_validity_ExtAction.rePrint}" value="Print And Digital Sign"
							onclick="submit">
							<f:setPropertyActionListener target="#{fL2D_Permit_validity_ExtAction.fl2dImportDataTable }" value="#{list2}" />
							</h:commandButton>
