			...
			<div class="form-group">
				...
				<div class="row " align="center">
					<div align="center" width="100%" class="pghead">
						...
						<h2>
						<h:inputHidden value="#{rollover_Stock_FL2D_18_19Action.hidden}"></h:inputHidden>
								...
								<TBODY>
									...
									<tr>
										<TD align="center" colspan="2"><h:outputLabel
												value="#{rollover_Stock_FL2D_18_19Action.unit_name}"
									...
									<TR>
										...
										<TD align="center" colspan="2"><h:outputLabel
												value="#{rollover_Stock_FL2D_18_19Action.unit_address}"
				...
				<div class="row">
					<div class="col-md-12" align="center">
						<rich:dataTable columnClasses="columnClass1"
							...
							id="table3" rows="10" 
							value="#{rollover_Stock_FL2D_18_19Action.displaylist}" var="list">
							<rich:column>
								<f:facet name="header">
							...
							<rich:column>
								...
								<h:selectOneMenu value="#{list.brandPackagingData_Brand}" styleClass="dropdown-menu"
							...
							<rich:column>
								...
								<h:outputText value="#{list.brandPackagingData_Quantity}" style=" width : 100px;"
							...
							<rich:column>
								...
								<a4j:outputPanel >
									<h:inputText value="#{list.box}"  style=" width : 100px;" styleClass="form-control">
							...
							<rich:column>
								<f:facet name="header">
									<h:commandButton class="img"
										action="#{rollover_Stock_FL2D_18_19Action.addRowMethod}"
										value=" ADD" image="/img/add.png" style=" width : 43px;" />
								</f:facet>
								<h:commandButton class="img"
									actionListener="#{rollover_Stock_FL2D_18_19Action.deleteRowMethod}"
							...
							<div class="col-md-12" align="center">
								...
								<div class="col-md-2" align="left">
									...
									<h:outputText disabled="true"
										value="#{rollover_Stock_FL2D_18_19Action.totalbox}" id="box"
										styleClass="generalHeaderOutputTable">
										<f:convertNumber maxFractionDigits="2"
											pattern="#############0" />
									</h:outputText>
								...
								<div class="col-md-2" align="left">
									...
									<h:outputText disabled="true"
										value="#{rollover_Stock_FL2D_18_19Action.totalmrp}" id="mrp"
										styleClass="generalHeaderOutputTable">
										<f:convertNumber maxFractionDigits="2"
											pattern="#############0.00" />
									</h:outputText>
								...
								<div class="col-md-2" align="left">
									...
									<h:outputText disabled="true"
										value="#{rollover_Stock_FL2D_18_19Action.totalrolloverfees}"
								...
								<div class="col-md-2" align="left">
									...
									<h:outputText disabled="true"
										value="#{rollover_Stock_FL2D_18_19Action.totalcowcess}"
				...
				<div class="panel-footer clearfix" align="center">
					<h:commandButton
						...
						action="#{rollover_Stock_FL2D_18_19Action.saveMethod}" value="Save">
					</h:commandButton>
					<rich:spacer width="10px"></rich:spacer>
					<h:commandButton styleClass="btn btn-warning"
						action="#{rollover_Stock_FL2D_18_19Action.reset}" value="Reset"></h:commandButton>
				</div>
				...
				<div class="row">
					<div class="col-md-12" align="center">
						<rich:dataTable columnClasses="columnClass1"
							...
							value="#{rollover_Stock_FL2D_18_19Action.displaylist1}" var="list">
							<rich:column>
								<f:facet name="header">
									<h:outputText value="Sr.No">
									</h:outputText>
...
<center>
						...
						action="#{rollover_Stock_FL2D_18_19Action.finaliz}"
						value="Finalize and send to DEO">
						<f:setPropertyActionListener value="#{list}"
										target="#{rollover_Stock_FL2D_18_19Action.prt}" />
					</h:commandButton>
					...
					<h:outputText value="Finalised "
							...
							<h:commandButton action="#{rollover_Stock_FL2D_18_19Action.finalizeData}" value="Finalize Data"  styleClass="btn btn-sm btn-danger" 
disabled="#{list.excel_flg_dis eq 'T'}"  rendered="#{list.excel_flg eq 'T'}"
									onclick="var e=this;setTimeout(function(){e.disabled=true;},0);return true;">
								<f:setPropertyActionListener value="#{list}" target="#{rollover_Stock_FL2D_18_19Action.prt }" />
								</h:commandButton>                                                            
								<h:outputLink target="_blank" value="/doc/ExciseUp/RolloverStock/Excel/#{list.planid}#{list.gtin_no}#{list.finalizedDateString}.xls">
