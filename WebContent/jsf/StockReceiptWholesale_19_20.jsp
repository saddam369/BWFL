				...
				<div class="panel-body">
					<TABLE width="100%" align="center">
						...
						<TR align="center" style="FONT-SIZE: x-large; FONT-WEIGHT: bold;">
							<TD><h:inputHidden value="#{fL2_2B_StockAction19_20.hidden}"></h:inputHidden>
								<h5>
									<h:outputText value="FL2 / 2B / CL2 STOCK RECEIVING 2019-20"
								...
								<TABLE width="100%" align="center">
									...
									<tr>
										<TD align="center" colspan="2"><h:outputLabel
												value="#{fL2_2B_StockAction19_20.name}"
									...
									<TR>
										...
										<TD align="center" colspan="2"><h:outputLabel
												value="#{fL2_2B_StockAction19_20.address}"
												...
												<TBODY align="center">
													...
													<tr>
														<TD colspan="4" align="center"><h:selectOneRadio
																style="width:20%;" value="#{fL2_2B_StockAction19_20.oldnew}">
																<f:selectItem itemValue="O" itemLabel="Stock Till 31 March,2020"
																	itemDisabled="#{fL2_2B_StockAction19_20.loginType eq 'CL2'}" />
																<f:selectItem itemValue="N" itemLabel="Stock After 1 May,2020" />
															</h:selectOneRadio> <h:selectOneRadio style="width:40%;"
																value="#{fL2_2B_StockAction19_20.licenseing}" >
													...
													<tr>
														<TD colspan="2" align="center">GatePass No : <h:inputText
																value="#{fL2_2B_StockAction19_20.gatePassNo}" />

														</TD>
														<TD colspan="2" align="center">Issue Gatepass Date :
															<rich:calendar value="#{fL2_2B_StockAction19_20.createdDate}"
															  />
														</TD>
													</tr>
													...
													<tr align="center">
														...
														<TD align="center" colspan="2"><h:commandButton
																action="#{fL2_2B_StockAction19_20.check}" value="Get Details"
									...
									id="table3" width="100%"
									value="#{fL2_2B_StockAction19_20.gatePssDisplaylist}" var="list">
						...
						<tr>
							<td style="text-align: center;"><h:commandButton
									...
									action="#{fL2_2B_StockAction19_20.saveMethod}" value="Save"
								...
								<rich:spacer width="10px"></rich:spacer> <h:commandButton
									...
									action="#{fL2_2B_StockAction19_20.reset}" value="Reset"></h:commandButton></td>
						</tr>
						...
						<tr>
							<td><rich:dataTable align="center" id="table55" rows="10"
									...
									value="#{fL2_2B_StockAction19_20.show_Data_table}"
									headerClass="TableHead" footerClass="TableHead"
