				...
				<div class="panel-body">
					<TABLE width="100%" align="center">
						...
						<TR align="center" style="FONT-SIZE: x-large; FONT-WEIGHT: bold;">
							<TD><h:inputHidden
									value="#{bWFLGatepass36_OldStock_18_19Action.hidden}"></h:inputHidden>
								<h5>
									<h:outputText
										value="GatePass From Distillery To District WholeSale 2019-20"
								...
								<TABLE width="100%" align="center">
									...
									<tr>
										<TD align="center" colspan="2"><h:outputLabel
												value="#{bWFLGatepass36_OldStock_18_19Action.bwflName}"
									...
									<TR>
										...
										<TD align="center" colspan="2"><h:outputLabel
												value="#{bWFLGatepass36_OldStock_18_19Action.bwflAdrs}"
												...
												<TBODY align="center">
													...
													<tr>
														<TD colspan="2" align="center">Date : <rich:calendar
																value="#{bWFLGatepass36_OldStock_18_19Action.dt_date}" />
														</TD>
														<TD colspan="2" align="center">Valid Till : <rich:calendar
																value="#{bWFLGatepass36_OldStock_18_19Action.validtilldt_date}" />
														</TD>
													</tr>
													<tr>
														<TD><rich:spacer height="10px"></rich:spacer></TD>
													...
													<tr align="center">
														...
														<TD align="left"><h:outputText
																value="#{bWFLGatepass36_OldStock_18_19Action.vch_from}" /></TD>
													...
													<tr align="center">
														...
														<TD align="left"><h:selectOneRadio
																value="#{bWFLGatepass36_OldStock_18_19Action.vch_to}"
																valueChangeListener="#{bWFLGatepass36_OldStock_18_19Action.listMethod}"
													...
													<td align="right" style="padding-right: 10px;">
														...
														rendered="#{bWFLGatepass36_OldStock_18_19Action.licNoflg}"
																 style="FONT-SIZE: small; FONT-WEIGHT: bold;">
															</h:outputText> 
															<h:outputText value="FL2B" 
															rendered="#{bWFLGatepass36_OldStock_18_19Action.licNoflg1}"
																style="FONT-SIZE: small; FONT-WEIGHT: bold;"></h:outputText>
															<h:outputText value="FL2/FL2B" 
															rendered="#{bWFLGatepass36_OldStock_18_19Action.licNoflg2}"
																style="FONT-SIZE: small; FONT-WEIGHT: bold;"></h:outputText>

														</td>
														<td align="left">
															<h:selectOneMenu rendered="#{bWFLGatepass36_OldStock_18_19Action.drpdwnFlg}"
																value="#{bWFLGatepass36_OldStock_18_19Action.vch_to_lic_no}"
																valueChangeListener="#{bWFLGatepass36_OldStock_18_19Action.waredrpMethod}"
																onchange="this.form.submit()"
																style="width: 250px; height: 28px;">
																<f:selectItems
																	value="#{bWFLGatepass36_OldStock_18_19Action.licNmbrList}" />
															</h:selectOneMenu>
															...
															<h:outputText
																value="HBR-"
																	rendered="#{bWFLGatepass36_OldStock_18_19Action.drpdwnFlg1}"
																...
																<h:inputText
																value="#{bWFLGatepass36_OldStock_18_19Action.brc_to_lic}"
																rendered="#{bWFLGatepass36_OldStock_18_19Action.drpdwnFlg1}"
...
>
															*Enter only digits w/o HBR.
															...
															<h:commandButton
																	...
																	rendered="#{bWFLGatepass36_OldStock_18_19Action.drpdwnFlg1}"
																		...
																		action="#{bWFLGatepass36_OldStock_18_19Action.fetch1}"
															value="Validate">
															</h:commandButton>
													...
													<tr style="padding-bottom: 10px;">
														...
														<td align="left"><h:inputText disabled="true"
																value="#{bWFLGatepass36_OldStock_18_19Action.licenseeDistrict}"
																styleClass="generalHeaderOutputTable"
																style="width:250px">
															</h:inputText></td>
													...
													<tr style="padding-bottom: 10px;">
														...
														<td align="left"><h:inputText disabled="true"
																value="#{bWFLGatepass36_OldStock_18_19Action.licenseeName}"
																styleClass="generalHeaderOutputTable"
																style="width:250px">
														...
														<td align="left"><h:inputTextarea disabled="true"
																value="#{bWFLGatepass36_OldStock_18_19Action.licenseeAdrs}"
																styleClass="generalHeaderOutputTable"
																style="width: 250px;">
													...
													<tr style="padding-bottom: 10px;">
														...
														<td align="left"><h:inputTextarea
																value="#{bWFLGatepass36_OldStock_18_19Action.routeDtl}"
																styleClass="generalHeaderOutputTable"
																style="width: 250px;">
														...
														<td align="left"><h:inputText
																value="#{bWFLGatepass36_OldStock_18_19Action.vehicleNo}"
																styleClass="generalHeaderOutputTable"
																style="width:250px">
													...
													<tr style="padding-bottom: 10px;">
														...
														<td align="left"><h:inputText
																value="#{bWFLGatepass36_OldStock_18_19Action.vehicleDrvrName}"
																styleClass="generalHeaderOutputTable"
																style="width:250px">
														...
														<td align="left"><h:inputTextarea
																value="#{bWFLGatepass36_OldStock_18_19Action.vehicleAgencyNmAdrs}"
																styleClass="generalHeaderOutputTable"
																style="width: 250px;">
													...
													<tr style="padding-bottom: 10px;">
														...
														<td align="left"><h:selectOneMenu
																value="#{bWFLGatepass36_OldStock_18_19Action.district1}"
																style="width: 250px; height: 28px;">
																<f:selectItems
																	value="#{bWFLGatepass36_OldStock_18_19Action.districtList}" />
															</h:selectOneMenu></td>


														<td align="left"><h:selectOneMenu
																value="#{bWFLGatepass36_OldStock_18_19Action.district2}"
																style="width: 250px; height: 28px;">
																<f:selectItems
																	value="#{bWFLGatepass36_OldStock_18_19Action.districtList}" />
															</h:selectOneMenu></td>
														...
														<td align="left"><h:selectOneMenu
																value="#{bWFLGatepass36_OldStock_18_19Action.district3}"
																style="width: 250px; height: 28px;">
																<f:selectItems
																	value="#{bWFLGatepass36_OldStock_18_19Action.districtList}" />
															</h:selectOneMenu></td>
													...
													<tr style="padding-bottom: 10px; padding-top: 10px;">
														...
														<TD align="left"
															style="FONT-WEIGHT: bold; padding-right: 10px;"><h:outputText
																...
																style="FONT-SIZE: small; FONT-WEIGHT: bold;"></h:outputText>
															<h:inputText
																value="#{bWFLGatepass36_OldStock_18_19Action.grossWeight}"
																styleClass="generalHeaderOutputTable"
																style="width:250px">
														...
														<td align="left"
															style="FONT-WEIGHT: bold; padding-right: 10px;"><h:outputText
																...
																style="FONT-SIZE: small; FONT-WEIGHT: bold;"></h:outputText>
															<h:inputText
																value="#{bWFLGatepass36_OldStock_18_19Action.tierWeight}"
																styleClass="generalHeaderOutputTable"
																style="width:250px">
																<a4j:support reRender="net-weight" event="onkeyup"></a4j:support>
															</h:inputText></td>
														<td align="left"
															...
															<a4j:outputPanel id="net-weight">
																<h:inputText
																	value="#{bWFLGatepass36_OldStock_18_19Action.netWeight}"
												...
												<tr align="center">
													...
													<tr style="padding-bottom: 10px; padding-top: 10px;">
														...
														<TD align="right"
															...
															<h:outputText rendered="#{bWFLGatepass36_OldStock_18_19Action.vch_to eq 'BRC'}"
																value="Challan no."
																style="FONT-SIZE: small; FONT-WEIGHT: bold;">
															</h:outputText></TD>
															<td align="left">
															<h:inputText rendered="#{bWFLGatepass36_OldStock_18_19Action.vch_to eq 'BRC'}"
																value="#{bWFLGatepass36_OldStock_18_19Action.challanNo}"
																styleClass="generalHeaderOutputTable"
																style="width:100px">
											...
											rendered="#{bWFLGatepass36_OldStock_18_19Action.vch_to eq 'BRC'}"
											 >Date : </h:outputText>
											 
											
											<rich:calendar 
											rendered="#{bWFLGatepass36_OldStock_18_19Action.vch_to eq 'BRC'}"
										   value="#{bWFLGatepass36_OldStock_18_19Action.challanDate}" />
														</TD>
														<td align="left"
														style="FONT-WEIGHT: bold; padding-right: 10px;">
															<h:outputText
															rendered="#{bWFLGatepass36_OldStock_18_19Action.vch_to eq 'BRC'}"
																...
																<h:inputText
																rendered="#{bWFLGatepass36_OldStock_18_19Action.vch_to eq 'BRC'}"
																	value="#{bWFLGatepass36_OldStock_18_19Action.challanAmount}"
								...
								rendered="#{bWFLGatepass36_OldStock_18_19Action.vch_to eq 'DW'}"
													headerClass="TableHead" footerClass="TableHead"
													rowClasses="TableRow1,TableRow2" styleClass="DataTable"
													id="table555" width="100%" rows="10"
													value="#{bWFLGatepass36_OldStock_18_19Action.displaylist1}" var="list"
												>
								 ...
								 <rich:dataTable columnClasses="columnClass1"
									...
									value="#{bWFLGatepass36_OldStock_18_19Action.displaylist}" var="list">
								...
								<rich:column rendered="#{bWFLGatepass36_OldStock_18_19Action.vch_to eq 'DW'}">
										<f:facet name="header">
											<h:outputText value="Indent No" />
										</f:facet>
										
										<h:inputText value="#{list.indentNumber}" 	style=" width : 93px;">
										</h:inputText>
									...
									<rich:column>
										...
										<h:outputText value="#{list.int_bottle_avaliable}" style=" width : 53px;">
										</h:outputText>
									</rich:column>
									...
									<rich:column>
										...
										<h:outputText value="#{list.boxAvailable}" style=" width : 53px;">
										</h:outputText>
									</rich:column>
...
<rich:column>
									...
									<rich:column>
										<f:facet name="header">
											<h:outputText value="Calculated Duty"  style=" white-space: normal;width : 53px;" 
												styleClass="generalHeaderOutputTable" />
										</f:facet>
									...
									<rich:column>
										<f:facet name="header">
											<h:outputText value="Calculated Add. Duty" style=" white-space: normal;width : 53px;"
												styleClass="generalHeaderOutputTable" />
										</f:facet>
								...
								<table>
									<tr>
										...
										<td align="right"><a4j:commandButton disabled="true"
												...
												actionListener="#{bWFLGatepass36_OldStock_18_19Action.calculateTotalDuty}"
												reRender="totalduty"
												value="Total Duty : #{bWFLGatepass36_OldStock_18_19Action.db_total_value}">
											</a4j:commandButton></td>
										<td align="right"><a4j:commandButton disabled="true"
												styleClass="btn btn-danger" id="totaladdduty"
												actionListener="#{bWFLGatepass36_OldStock_18_19Action.calculateTotalAddDuty}"
												reRender="totaladdduty"
												value="Total Additional Duty : #{bWFLGatepass36_OldStock_18_19Action.db_total_add_value}">
											</a4j:commandButton></td>
<td align="right"><a4j:commandButton disabled="true"
												styleClass="btn btn-danger" id="totalcesh" 
												value="Total Special Additional Duty : #{bWFLGatepass36_OldStock_18_19Action.ceshsum}">
											</a4j:commandButton></td>
									</tr>
									<tr></tr>
								</table>
						...
						<tr>
							<td style="text-align: center;"><h:commandButton
									styleClass="btn btn-primary"
									action="#{bWFLGatepass36_OldStock_18_19Action.saveMethod}"
									value="Save"
								...
								<rich:spacer width="10px"></rich:spacer> <h:commandButton
									...
									action="#{bWFLGatepass36_OldStock_18_19Action.clearAll}" value="Reset"></h:commandButton></td>
					...
					<div class="row">
						<rich:dataTable align="center" id="table55" rows="10" width="100%"
							var="list11" value="#{bWFLGatepass36_OldStock_18_19Action.table2List }"
							headerClass="TableHead" footerClass="TableHead"
							...
							<rich:column>
								...
								<center>
									...
									<h:commandButton styleClass="btn btn-success"
										...
										actionListener="#{bWFLGatepass36_OldStock_18_19Action.printDraftreport}"></h:commandButton>

									<h:outputLink styleClass="outputLinkEx"
										value="/doc/ExciseUp/WholeSale/pdf//#{bWFLGatepass36_OldStock_18_19Action.draftpdfname}"
										target="_blank">
									...
									<h:commandButton styleClass="btn btn-success" value="Print"
										actionListener="#{bWFLGatepass36_OldStock_18_19Action.printReport }"
										rendered="#{list11.finalizePrint}"></h:commandButton>

									<h:outputLink styleClass="outputLinkEx"
										value="/doc/ExciseUp/WholeSale/pdf//#{bWFLGatepass36_OldStock_18_19Action.pdfname}"
										target="_blank">
									...
									<h:commandButton styleClass="btn btn-success"
										...
										actionListener="#{bWFLGatepass36_OldStock_18_19Action.scanAndUpload}">
									</h:commandButton>
							...
							<rich:column>
								...
								<h:commandButton styleClass="btn btn-danger"
									...
									action="#{bWFLGatepass36_OldStock_18_19Action.cancel}">
									<f:setPropertyActionListener
										target="#{bWFLGatepass36_OldStock_18_19Action.edidata}"
										value="#{list11}" />
								</h:commandButton>
						...
						<table align="center">
							...
							<tr>
								...
								<TD align="center"><h:selectOneRadio
										value="#{bWFLGatepass36_OldStock_18_19Action.exclcsv}"
										rendered="#{bWFLGatepass36_OldStock_18_19Action.gatePassFlag}"
										onchange="this.form.submit()"> 
							...
							<tr align="left">
								...
								<h:outputText rendered="#{bWFLGatepass36_OldStock_18_19Action.gatePassFlag}"
								...
								<td style="FONT-SIZE: large; color: Red"><h:outputText
										value="#{bWFLGatepass36_OldStock_18_19Action.scanGatePassNo}"
										rendered="#{bWFLGatepass36_OldStock_18_19Action.exclcsv eq 'E' or bWFLGatepass36_OldStock_18_19Action.exclcsv eq 'C'}" /></td>
								<TD><h:outputLink value="/doc/ExciseUp/ExcelFormatBWFL.pdf"
										rendered="#{bWFLGatepass36_OldStock_18_19Action.gatePassFlag}"
										target="_blank">
										<h:graphicImage value="/img/i.png" style="width:40px;"
											rendered="#{bWFLGatepass36_OldStock_18_19Action.exclcsv eq 'E' or bWFLGatepass36_OldStock_18_19Action.exclcsv eq 'C'}">
										</h:graphicImage>
									</h:outputLink></TD>

								<td><rich:fileUpload addControlLabel="Add File" id="link3"
										fileUploadListener="#{bWFLGatepass36_OldStock_18_19Action.uploadExcel}"
										rendered="#{bWFLGatepass36_OldStock_18_19Action.gatePassFlag and bWFLGatepass36_OldStock_18_19Action.exclcsv eq 'E'}"
								...
								<td><h:commandButton value="Upload"
										rendered="#{bWFLGatepass36_OldStock_18_19Action.gatePassFlag and bWFLGatepass36_OldStock_18_19Action.exclcsv eq 'E'}"
										styleClass="btn btn-primary"
										action="#{bWFLGatepass36_OldStock_18_19Action.importExcel}">
									</h:commandButton></td>


								<td><rich:fileUpload addControlLabel="Add File" id="link34"
										fileUploadListener="#{bWFLGatepass36_OldStock_18_19Action.uploadCsv}"
										rendered="#{bWFLGatepass36_OldStock_18_19Action.gatePassFlag and bWFLGatepass36_OldStock_18_19Action.exclcsv eq 'C'}"
										maxFilesQuantity="1" listHeight="40" listWidth="250"
										clearControlLabel="clear" stopControlLabel="Stop"
								...
								<td><h:commandButton value="upload CSV"
										styleClass="btn btn-primary"
										rendered="#{bWFLGatepass36_OldStock_18_19Action.gatePassFlag and bWFLGatepass36_OldStock_18_19Action.exclcsv eq 'C'}"
										action="#{bWFLGatepass36_OldStock_18_19Action.csvSubmit }">
									</h:commandButton></td>
						...
						<div>
							<rich:dataTable align="center" id="table57" rows="10"
								width="100%" var="listk"
								rendered="#{bWFLGatepass36_OldStock_18_19Action.tableFlag}"
								value="#{bWFLGatepass36_OldStock_18_19Action.getVal }"
								headerClass="TableHead" footerClass="TableHead"
								rowClasses="TableRow1,TableRow2">
						...
						<table align="center">
							<tr>
								<td><h:commandButton value="Finalise"
										styleClass="btn btn-primary"
										rendered="#{bWFLGatepass36_OldStock_18_19Action.tableFlag}" disabled="#{bWFLGatepass36_OldStock_18_19Action.bottlingNotDoneFlag }"
										action="#{bWFLGatepass36_OldStock_18_19Action.finalSubmit}">


									</h:commandButton> <h:commandButton value="Cancel" styleClass="btn btn-danger"
										rendered="#{bWFLGatepass36_OldStock_18_19Action.tableFlag}"
										action="#{bWFLGatepass36_OldStock_18_19Action.delete}">
									</h:commandButton></td>
