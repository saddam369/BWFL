					...
					<TABLE width="100%" align="center">
									...
									<TBODY>
										<TR align="center">
											...
											<TD align="center" width="100%" class="pghead"><h:inputHidden
													value="#{bWFLImportAction.mappedhidden}"></h:inputHidden>
												<h2>
										...
										<tr>
											<TD align="center" colspan="2"><h:outputLabel
													value="#{bWFLImportAction.distillery_nm}"
										...
										<TR>
											<TD align="center" colspan="2"><h:outputLabel
													value="#{bWFLImportAction.distillery_adrs}"
						...
						<tr align="center">
							<td><h:outputText value="License No"></h:outputText> <h:selectOneMenu
									value="#{bWFLImportAction.select_lic_no}"
									onchange="this.form.submit();">
									<f:selectItems value="#{bWFLImportAction.licno}" />
								</h:selectOneMenu></td>
						</tr>
						<TR>
							<TD><rich:dataTable columnClasses="columnClass1"
									...
									value="#{bWFLImportAction.showDataTableList}" var="list">
									<rich:column>
										<f:facet name="header">
									...
									<rich:column>
										...
										<h:commandButton action="#{bWFLImportAction.finalizeData}"
									...
									<rich:column>
										...
										action="#{bWFLImportAction.showPopUpData}"
										oncomplete="#{rich:component('popup2')}.show()" reRender="messages,messages1,msg2,sv"
										styleClass="btn btn-sm btn-success" >
										<f:setPropertyActionListener target="#{bWFLImportAction.datatable }" value="#{list}" />
										</a4j:commandButton>
			...
			<TABLE width="80%">
				...
				<div class="col-md-12">
					<h:commandButton value="Save" styleClass="btn btn-success btn-sm" id="sv"
						 action="#{bWFLImportAction.cancelRequest}" disabled="#{bWFLImportAction.popup eq 'S' }"></h:commandButton>
