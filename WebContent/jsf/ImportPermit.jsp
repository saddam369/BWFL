<ui:composition xmlns="http://www.w3.org/1999/xhtml"
	...
	<f:view>
		<h:form>
			<h:inputHidden value="#{importPermitAction.hidden}"></h:inputHidden>
			...
			<h:panelGroup>
				<div class="row" style="background-color: #8585ad;">
					<div class="col-md-2">
						...
						<div class="row" align="center">
							...
							<h:commandButton value="New Import Permit"
								action="#{importPermitAction.new_indent}"
								styleClass="form-control"
								style="color:#FFFFFF;  background-color: #8585ad; width: 100%;font-size: 1em">
							</h:commandButton>
						</div>
						<div class="row" align="center">
							<h:commandButton value="Import Permit Challan"
								action="#{importPermitAction.mappingPage}"
								styleClass="form-control"
								style="color:#FFFFFF;  background-color: #8585ad; width: 100%;font-size: 1em">
						...
						<div class="row" align="center">
							<h:commandButton value="Import Permit Status"
								action="#{importPermitAction.his_indent}"
								styleClass="form-control"
								style="color:#FFFFFF;  background-color: #8585ad; width: 100%;font-size: 1em">
					...
					<div class="col-md-10" style="background-color: #ffffff;">
						...
						<h:panelGroup rendered="#{importPermitAction.panel eq 'T'}">
							<div style="padding: 10px; border: 4px groove #2948a4;">
								...
								<div class="row" align="center">
									<h:outputLabel value="#{importPermitAction.vch_firm_name}"
										style="COLOR: #000000; FONT-SIZE: x-large;"></h:outputLabel>
								</div>
								<div class="row" align="center">
									<h:outputLabel value="#{importPermitAction.vch_firm_add}"
									...
									<div class="col-md-11 col-sm-12">
										...
										<div class="row">
											<div class="col-md-6" align="left"
												...
												<b style="COLOR: #000080;">Name: </b>${importPermitAction.vch_firm_name
												}
											</div>
											<div class="col-md-6" align="left"
												style="margin-bottom: 5px;">
												<b style="COLOR: #000080;">Licence No.: </b>
												${importPermitAction.vch_license_number }
											</div>

											<div class="col-md-6" align="left"
												style="margin-bottom: 5px;">
												<b style="COLOR: #000080;">District: </b>${importPermitAction.vch_firm_district_name
												}
											</div>
											<div class="col-md-6" align="left"
												style="margin-bottom: 5px;">
												<b style="COLOR: #000080;">Current Date :</b>
												${importPermitAction.cr_date }
											</div>

											<div class="col-md-6" align="left"
												style="margin-bottom: 5px;">
												<b style="COLOR: #000080;">Parent Unit Name :</b>${importPermitAction.vch_associated_unit_name
												}
											</div>

											<div class="col-md-6" align="left"
												style="margin-bottom: 5px;">
												<b style="COLOR: #000080;">Parent Unit State: </b>${importPermitAction.state_name
												}
											</div>
											<div class="col-md-6" align="left"
												style="margin-bottom: 5px;">
												<b style="COLOR: #000080;">Parent Unit Address: </b>${importPermitAction.vch_reg_office_add
												}
											</div>
						...
						<h:panelGroup rendered="#{importPermitAction.panel eq 'N'}">
							<div style="padding: 10px; border: 4px groove #2948a4;">
								<div class="row">
										...
										<div class="col-md-12 col-sm-12" style="padding: 0px;">
											...
											<div style="overflow-x: scroll; width: 100%;">
												<rich:dataTable columnClasses="columnClass1"
													...
													value="#{importPermitAction.displaylist}" var="list">
													...
													<rich:column align="center"
														rendered="#{importPermitAction.vch_license_type ne 99 }">
														<f:facet name="header">
													...
													<rich:column>
														<f:facet name="header">
															<h:commandButton class="imag"
																...
																action="#{importPermitAction.addRowMethodPackaging}"
																image="/img/add.png" />
														</f:facet>
														<h:commandButton class="imag"
															actionListener="#{importPermitAction.deleteRowMethodPackaging}"
											...
											<div class="row" align="center">
												<a4j:commandButton rendered="true" disabled=""
													...
													value="Total Duty : #{importPermitAction.duty_msg}">
												...
												<a4j:commandButton rendered="true" disabled=""
													...
													value="Total Import Fee: #{importPermitAction.total_import_fees}">
												...
												<a4j:commandButton rendered="true" disabled=""
													...
													reRender="totalpermitfee"
													value="Total Special Fee : #{importPermitAction.total_special_fee}">
											...
											<div class="row">
												...
												<div class="col-sm-6" align="left">
													<h:selectOneRadio value="#{importPermitAction.bottlngType}">
											...
											<div class="row">
												<div class="col-md-6" align="right">
													<b>Route Detail:</b>
													<h:inputTextarea value="#{importPermitAction.route_detail}"
														style="width : 240px; height : 42px;"></h:inputTextarea>
												</div>
												<div class="col-md-6" align="left">
													<h:selectOneRadio
														value="#{importPermitAction.route_road_radio}">
											 ...
											 <div style="BACKGROUND-COLOR: #f1f1f3; COLOR: #000000;">
													...
													<div class="row">
														<h:panelGroup rendered="false">
															<div class="col-sm-4" align="left">
																<b>Duty: </b>${importPermitAction.duty_balance }
															</div>
														</h:panelGroup>
														<div class="col-sm-4" align="left">
															...
															<h:outputText
																value="#{importPermitAction.importFee_balance}" />
														</div>
														<div class="col-sm-4" align="left">
															<h:outputText value="Special Fee: "
																style="FONT-WEIGHT: bold;" />
															<h:outputText
																value="#{importPermitAction.specialFee_balance}" />
														</div>
													</div>
												</h:panelGroup>
												<div class="row">
												...
												<div class="row">
													...
													<div class="col-sm-6" align="left">
														...
														<h:selectOneMenu
															value="#{importPermitAction.import_fee_challan_no}"
															style=" white-space: normal;width : 200px; height: 21px;">
															<f:selectItems
																value="#{importPermitAction.importChallanList}" />
														</h:selectOneMenu>
													</div>
													<div class="col-sm-6" align="left">
														<h:outputText value="Special Fee Challan No: "
															style="FONT-WEIGHT: bold;" />
														<h:selectOneMenu
															value="#{importPermitAction.spcl_fee_challan_no}"
															style=" white-space: normal;width : 200px; height: 21px;">
															<f:selectItems
																value="#{importPermitAction.spclChallanList}" />
														</h:selectOneMenu>
													</div>
												</div>
												<div class="row">
											...
											<div>
												<a4j:outputPanel id="save_btn">
													<h:commandButton value="Save"
														onclick="if (! confirm('No. of Cases-#{importPermitAction.total_no_of_cases}, Import Fee-#{importPermitAction.total_import_fees},Special Fee-#{importPermitAction.total_special_fee}, Duty-#{importPermitAction.duty_msg}') ) { return false;}; return true; "
														action="#{importPermitAction.save}"
														style="color:#FFFFFF; background-color: #253f8a;">
													</h:commandButton>
												</a4j:outputPanel>
												<h:commandButton value="Reset"
													action="#{importPermitAction.reset}"
													style="color:#FFFFFF; background-color: #253f8a;">
												</h:commandButton>
												<h:commandButton value="Back"
													action="#{importPermitAction.home}"
													style="color:#FFFFFF; background-color: #253f8a;">
												</h:commandButton>
						...
						<h:panelGroup rendered="#{importPermitAction.panel eq 'H'}">
									...
									<div class="col-md-12 col-sm-12">
										...
										<div class="row">
											<rich:dataTable columnClasses="columnClass1"
												...
												value="#{importPermitAction.hislist}" var="list">
												...
												<rich:column>
													...
													<center>
														<h:commandButton value="View Detail"
															...
															actionListener="#{importPermitAction.view}">

														</h:commandButton>
														<h:commandButton value="Delete"
															rendered="#{list.dt_vch_status eq 'Pending' }"
															styleClass="btn btn-danger btn-sm"
															actionListener="#{importPermitAction.deletelisnr}">

														</h:commandButton>

														<h:outputLink styleClass="outputLinkEx"
															rendered="#{list.digital_sign_pdf_name ne 'NUL' }"
															value="/doc/ExciseUp/Bond/BWFLpermit/#{list.digital_sign_pdf_name}"
															target="_blank">
										...
										<h:panelGroup rendered="#{importPermitAction.flag ne 'F'}">
											<div class="row">
												...
												<div style="overflow-x: scroll; width: 100%;">
													<rich:dataTable columnClasses="columnClass1"
														...
														value="#{importPermitAction.brand_pack_list}" var="list10">
											...
											<div>
												<h:commandButton value="Close"
													action="#{importPermitAction.close}"
