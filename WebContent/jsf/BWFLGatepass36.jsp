							...
							<TD align="center">
								<TABLE width="100%" align="center">
									...
									<TR style="text-align: center; padding: 5px;">
										<td >
										   <h:outputText value="Advance Consideration Fee : "></h:outputText>
									...
									<TR style="text-align: center ; padding: 5px;">
										<td >
										   <h:outputText value="Advance Duty : "></h:outputText>
										   <h:inputText disabled="true" value="#{gatepassToDistrictBWFLAction.adv_duty}">
										   <f:convertNumber maxFractionDigits="2"
																	pattern="#############0.00" /></h:inputText>
										</td>
