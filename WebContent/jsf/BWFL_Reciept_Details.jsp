...
.textarea1 {
		...
		<h:form >
			<div class="container">
				...
				<div class="row" align="center">
					<div class="col-md-12">
						<h:outputLabel value="BWFL Reciept"
							style="text-align:center;font-family:Calibri;font-weight:bold;font-size:35px;" />

						<h:inputHidden value="#{bWFL_RecieptAction.hidden}" />
					</div>
				</div>
				<br /> <br />
				<div class="row">
					<div class="col-md-12">
						...
						<rich:dataTable align="center" styleClass="table-responsive"
							...
							value="#{bWFL_RecieptAction.bwfl_datalist}" var="list"
							...
							<rich:column id="column4">
								...
								<center>
									<h:commandButton value="View Details"
										action="#{bWFL_RecieptAction.view_details}"
										styleClass="btn btn-sm btn-primary">

										<f:setPropertyActionListener value="#{list}"
											target="#{bWFL_RecieptAction.reciptDetail }" />
				...
				<h:panelGroup rendered="#{bWFL_RecieptAction.view_full_form_flag}">
					<rich:dataTable align="center" styleClass="table-responsive"
						width="100%" id="rento" rows="10"
						value="#{bWFL_RecieptAction.view_formData}" var="list1"
						style="FONT-FAMILY: 'Baskerville Old Face';"
						headerClass="TableHead" footerClass="TableHead"
						rowClasses="TableRow1,TableRow2">
	...
	<rich:column>
				...
				<div class="row">
					<div class="col-md-12">
					<center>
								<h:commandButton value="Save" rendered="#{bWFL_RecieptAction.view_full_form_flag}"
									actionListener="#{bWFL_RecieptAction.save}"
									styleClass="btn btn-sm btn-primary" />
									<rich:spacer width="30px"></rich:spacer>
									<h:commandButton value="Reset"
									action="#{bWFL_RecieptAction.reset}"
									styleClass="btn btn-sm btn-primary" />
							</center>
				</div></div>
<br /> <br />
				<rich:dataTable align="center" styleClass="table-responsive"
					...
					value="#{bWFL_RecieptAction.reciept_list}" var="list2"
					style="FONT-FAMILY: 'Baskerville Old Face';"
					headerClass="TableHead" footerClass="TableHead"
					rowClasses="TableRow1,TableRow2">
